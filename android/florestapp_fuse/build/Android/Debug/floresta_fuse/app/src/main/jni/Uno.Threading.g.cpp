...
::g::Uno::Threading::Future_type* TaskFuture_typeof()
{
    ...
    type->SetPrecalc(
        ::TYPES[27/*Uno.Func`1*/]->MakeType(type->T(0)));
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::Threading::Future_type, interface0));
    type->SetFields(8,
...
Thread_type* Thread_typeof()
{
    ...
    ::STRINGS[0] = uString::Const("Feature not supported in this backend");
    ::TYPES[28] = ::g::Uno::Threading::POSIXThread_typeof();
    type->SetFields(0,
...
ThreadPool_type* ThreadPool_typeof()
{
    ...
    ::TYPES[29] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(ThreadPool__WorkItem_typeof());
    ::TYPES[30] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Threading::Thread_typeof());
    ::TYPES[5] = ::g::Uno::Action_typeof();
    ::TYPES[31] = ::g::Uno::Bool_typeof();
    ::TYPES[32] = ThreadPool__WorkItem_typeof();
    ::TYPES[19] = ::g::Uno::Threading::Thread_typeof();
    type->SetInterfaces(
...
void ThreadPool::ctor_(int poolSize)
{
    ...
    _taskQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[29/*Uno.Threading.ConcurrentQueue<Uno.Threading.ThreadPool.WorkItem>*/]));
    _running = true;
    _disposeQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[30/*Uno.Threading.ConcurrentQueue<Uno.Threading.Thread>*/]));
    _poolSize = poolSize;
...
{
    uPtr(uPtr(::g::Uno::Application::Current())->Window())->add_Closed(uDelegate::New(::TYPES[35/*Uno.EventHandler*/], (void*)ThreadPoolTaskScheduler__OnWindowClosed_fn));
}
...
ThreadPoolTaskScheduler_type* ThreadPoolTaskScheduler_typeof()
{
    ...
    ::TYPES[34] = ::g::Uno::Application_typeof();
