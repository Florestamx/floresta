...
struct ZonedDateTime : uObject
{
    ...
    void ctor_3(::g::Uno::Time::LocalDateTime* localDateTime, ::g::Uno::Time::Offset offset, ::g::Uno::Time::DateTimeZone* zone);
    int Day();
    ...
    static ZonedDateTime* New4(::g::Uno::Time::LocalDateTime* localDateTime, ::g::Uno::Time::Offset offset, ::g::Uno::Time::DateTimeZone* zone);
    static ZonedDateTime* op_Subtraction(ZonedDateTime* zonedDateTime, ::g::Uno::Time::Duration duration);
