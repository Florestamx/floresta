...
uType* Face_typeof()
{
    ...
    ::TYPES[7] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::HalfEdge_typeof());
    type->SetFields(0,
...
::g::Fuse::Drawing::Tesselation::Collections::LinkedListEnumerable_type* FacesEnumerable_typeof()
{
    ...
    type->interface0.fp_GetEnumerator = (void(*)(uObject*, uObject**))::g::Fuse::Drawing::Tesselation::Collections::LinkedListEnumerable__GetEnumerator_fn;
    ::TYPES[8] = ::g::Fuse::Drawing::Tesselation::Face_typeof();
    type->SetInterfaces(
...
{
    return *__retval = (uPtr(v)->Next() == __this->_head) ? uCast< ::g::Fuse::Drawing::Tesselation::Face*>(NULL, ::TYPES[8/*Fuse.Drawing.Tesselation.Face*/]) : (::g::Fuse::Drawing::Tesselation::Face*)uPtr(v)->Next(), void();
}
...
{
    ::g::Fuse::Drawing::Tesselation::Collections::LinkedListEnumerable__ctor__fn(this, (uPtr(head)->Next() == head) ? uCast< ::g::Fuse::Drawing::Tesselation::Face*>(NULL, ::TYPES[8/*Fuse.Drawing.Tesselation.Face*/]) : (::g::Fuse::Drawing::Tesselation::Face*)uPtr(head)->Next());
    _head = head;
}
...
uType* Mesh_typeof()
{
    ...
    ::TYPES[10] = ::g::Uno::Bool_typeof();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[12] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::HalfEdge_typeof());
    ::TYPES[13] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Fuse::Drawing::Tesselation::Face_typeof(), ::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[14] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Face_typeof(), ::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[15] = ::g::Uno::Int_typeof();
    ::TYPES[16] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Face_typeof());
    ::TYPES[7] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::HalfEdge_typeof());
...
void Mesh::DeleteInternalEdges()
{
    ...
    for (uObject* enum4 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Edges()), ::TYPES[7/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.HalfEdge>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum4), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ::g::Fuse::Drawing::Tesselation::HalfEdge* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum4), ::TYPES[12/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.HalfEdge>*/]), &ret10), ret10);
...
void Mesh::Dispose()
{
    ...
    for (uObject* enum5 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Edges()), ::TYPES[7/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.HalfEdge>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum5), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ::g::Fuse::Drawing::Tesselation::HalfEdge* edge = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum5), ::TYPES[12/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.HalfEdge>*/]), &ret12), ret12);
...
{
    return (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[13/*Uno.Collections.EnumerableExtensions.Select<Fuse.Drawing.Tesselation.Face, Fuse.Drawing.Contour>*/], InteriorFaces(), uDelegate::New(::TYPES[14/*Uno.Func<Fuse.Drawing.Tesselation.Face, Fuse.Drawing.Contour>*/], (void*)Mesh__CreateContour_fn, this));
}
...
void Mesh::SetWindingNumber(int value)
{
    ...
    for (uObject* enum3 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Edges()), ::TYPES[7/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.HalfEdge>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum3), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ::g::Fuse::Drawing::Tesselation::HalfEdge* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum3), ::TYPES[12/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.HalfEdge>*/]), &ret13), ret13);
...
void Mesh::TessellateInterior()
{
    ...
    {
        ::g::Fuse::Drawing::Tesselation::Face* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[16/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.Face>*/]), &ret14), ret14);
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[11/*"["*/], uBox(::TYPES[11/*double*/], __this->S)), ::STRINGS[12/*", "*/]), uBox(::TYPES[11/*double*/], __this->T)), ::STRINGS[13/*"]"*/]), void();
}
