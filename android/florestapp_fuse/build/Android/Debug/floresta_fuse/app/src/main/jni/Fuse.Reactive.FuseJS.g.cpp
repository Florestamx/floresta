...
void Environment::ctor_1()
{
    ...
    ctor_(uArray::New(::TYPES[0/*Fuse.Scripting.NativeMember[]*/], 0));
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[19/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[42/*"android"*/], uCRef(true), &ret2), ret2));
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[19/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[43/*"iOS"*/], uCRef(false), &ret3), ret3));
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[19/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[46/*"preview"*/], uCRef(false), &ret6), ret6));
}
...
{
    if (uPtr(args)->Length() > 0)
        uPtr(_req)->EnableCache(uUnbox<bool>(::TYPES[38/*bool*/], uPtr(args)->Strong<uObject*>(0)));
...
{
    return uBox<int>(::TYPES[39/*int*/], uPtr(_req)->State());
}
...
void Http__FuseJSHttpRequest::OnProgress(::g::Uno::Net::Http::HttpMessageHandlerRequest* res, int current, int total, bool hastotal)
{
    ...
    if (func != NULL)
        uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 3, uBox<int>(::TYPES[39/*int*/], current), uBox<int>(::TYPES[39/*int*/], total), uBox(::TYPES[38/*bool*/], hastotal)));
}
...
void Http__FuseJSHttpRequest::OnStateChanged(::g::Uno::Net::Http::HttpMessageHandlerRequest* res)
{
    ...
    if (func != NULL)
        uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, uBox<int>(::TYPES[39/*int*/], uPtr(_req)->State())));
}
...
::g::Fuse::Scripting::NativeModule_type* GeoLocation_typeof()
{
    ...
    ::TYPES[0] = ::g::Fuse::Scripting::NativeMember_typeof()->Array();
    ::TYPES[1] = ::g::Fuse::Scripting::NativeMember_typeof();
    ::TYPES[40] = ::g::Fuse::Scripting::NativeProperty_typeof()->MakeType(::g::Fuse::GeoLocation::GeoLocationAuthorizationType_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[41] = ::g::Uno::Func_typeof()->MakeType(::g::Fuse::GeoLocation::GeoLocationAuthorizationType_typeof());
    ::TYPES[29] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Int_typeof());
    ::TYPES[42] = ::g::Fuse::Scripting::ValueConverter_typeof()->MakeType(::g::Fuse::GeoLocation::GeoLocationAuthorizationType_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[2] = ::g::Fuse::Scripting::NativeCallback_typeof();
    ::TYPES[43] = ::g::Fuse::GeoLocation::LocationTracker_typeof();
    ::TYPES[44] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::GeoLocation::Location_typeof());
    ::TYPES[45] = ::g::Fuse::Scripting::NativeProperty_typeof()->MakeType(::g::Fuse::GeoLocation::Location_typeof(), ::g::Fuse::Scripting::Object_typeof());
    ::TYPES[46] = ::g::Uno::Func_typeof()->MakeType(::g::Fuse::GeoLocation::Location_typeof());
    ::TYPES[47] = ::g::Fuse::Scripting::ValueConverter_typeof()->MakeType(::g::Fuse::GeoLocation::Location_typeof(), ::g::Fuse::Scripting::Object_typeof());
    ::TYPES[48] = ::g::Fuse::Scripting::NativePromise_typeof()->MakeType(::g::Fuse::GeoLocation::Location_typeof(), ::g::Fuse::Scripting::Object_typeof());
    ::TYPES[49] = ::g::Fuse::Scripting::FutureFactory_typeof()->MakeType(::g::Fuse::GeoLocation::Location_typeof());
    ::TYPES[50] = ::g::Fuse::Scripting::ResultConverter_typeof()->MakeType(::g::Fuse::GeoLocation::Location_typeof(), ::g::Fuse::Scripting::Object_typeof());
    ::TYPES[39] = ::g::Uno::Int_typeof();
    ::TYPES[8] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[5] = uObject_typeof();
    ::TYPES[51] = ::g::Fuse::GeoLocation::GeoCoordinates_typeof();
    ::TYPES[52] = ::g::Fuse::GeoLocation::Location_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[53] = ::g::Fuse::GeoLocation::GeoLocationAuthorizationType_typeof();
    type->SetInterfaces(
        ::g::Fuse::Scripting::IModule_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface0));
    type->SetFields(3,
...
void GeoLocation::ctor_1()
{
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty*)::g::Fuse::Scripting::NativeProperty::New2(::TYPES[40/*Fuse.Scripting.NativeProperty<Fuse.GeoLocation.GeoLocationAuthorizationType, int>*/], ::STRINGS[72/*"auhtorizati...*/], uDelegate::New(::TYPES[41/*Uno.Func<Fuse.GeoLocation.GeoLocationAuthorizationType>*/], (void*)GeoLocation__GetAuhtorizationRequest_fn, this), uDelegate::New(::TYPES[29/*Uno.Action<int>*/], (void*)GeoLocation__SetAuhtorizationRequest_fn, this), uDelegate::New(::TYPES[42/*Fuse.Scripting.ValueConverter<Fuse.GeoLocation.GeoLocationAuthorizationType, int>*/], (void*)GeoLocation__AuthorizationRequestConverter_fn)));
    ...
    uPtr(_locationTracker)->add_LocationChanged(uDelegate::New(::TYPES[44/*Uno.Action<Fuse.GeoLocation.Location>*/], (void*)GeoLocation__LocationChanged_fn, this));
    AddMember(_onChangedEvent);
    AddMember((::g::Fuse::Scripting::NativeProperty*)::g::Fuse::Scripting::NativeProperty::New2(::TYPES[45/*Fuse.Scripting.NativeProperty<Fuse.GeoLocation.Location, Fuse.Scripting.Object>*/], ::STRINGS[76/*"location"*/], uDelegate::New(::TYPES[46/*Uno.Func<Fuse.GeoLocation.Location>*/], (void*)GeoLocation__GetLocation_fn, this), NULL, uDelegate::New(::TYPES[47/*Fuse.Scripting.ValueConverter<Fuse.GeoLocation.Location, Fuse.Scripting.Object>*/], (void*)GeoLocation__Converter_fn)));
    AddMember((::g::Fuse::Scripting::NativePromise*)::g::Fuse::Scripting::NativePromise::New1(::TYPES[48/*Fuse.Scripting.NativePromise<Fuse.GeoLocation.Location, Fuse.Scripting.Object>*/], ::STRINGS[77/*"getLocation"*/], uDelegate::New(::TYPES[49/*Fuse.Scripting.FutureFactory<Fuse.GeoLocation.Location>*/], (void*)GeoLocation__GetLocationAsync_fn, this), uDelegate::New(::TYPES[50/*Fuse.Scripting.ResultConverter<Fuse.GeoLocation.Location, Fuse.Scripting.Object>*/], (void*)GeoLocation__Converter_fn)));
}
...
::g::Fuse::Scripting::Object* GeoLocation::Converter(::g::Fuse::Scripting::Context* context, ::g::Fuse::GeoLocation::Location* location)
{
    ...
    if (location != NULL)
    {
        uPtr(obj)->Item(::STRINGS[78/*"latitude"*/], uBox(::TYPES[65/*double*/], uPtr(uPtr(location)->Coordinates())->Latitude()));
        obj->Item(::STRINGS[79/*"longitude"*/], uBox(::TYPES[65/*double*/], uPtr(location->Coordinates())->Longitude()));
        obj->Item(::STRINGS[80/*"accuracy"*/], uBox(::TYPES[65/*double*/], location->Accuracy()));
    }
...
uClassType* Globals_typeof()
{
    ...
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[4] = ::g::Uno::String_typeof();
    ::TYPES[55] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof());
    return type;
}
...
{
    return uIs(obj, ::TYPES[54/*Uno.UX.BundleFileSource*/]);
}
...
uString* Globals::readAsText(uArray* args)
{
    ...
    if (::g::Uno::UX::Resource::TryFindGlobal(key, uDelegate::New(::TYPES[55/*Uno.Predicate<object>*/], (void*)Globals__FileSourceAcceptor_fn), &res))
    {
        ::g::Uno::UX::BundleFileSource* fs = uCast< ::g::Uno::UX::BundleFileSource*>(res, ::TYPES[54/*Uno.UX.BundleFileSource*/]);
...
uType* Http_typeof()
{
    ...
    ::TYPES[9] = ::g::Fuse::Scripting::Context_typeof();
    ::TYPES[5] = uObject_typeof();
    ::TYPES[56] = ::g::Fuse::Reactive::FuseJS::FunctionClosure_typeof();
    ::TYPES[22] = ::g::Uno::Func2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), uObject_typeof()->Array(), uObject_typeof());
    ::TYPES[57] = Http__FuseJSHttpClient_typeof();
    return type;
}
...
{
    InterApp::_cachedUris_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[58/*Uno.Collections.List<string>*/]));
    ::g::Uno::Platform2::Application::add_ReceivedURI(uDelegate::New(::TYPES[60/*Uno.EventHandler<string>*/], (void*)InterApp__OnReceivedUri_fn));
}
...
uType* InterApp_typeof()
{
    ...
    ::TYPES[58] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[59] = ::g::Uno::Platform2::Application_typeof();
    ::TYPES[60] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[0] = ::g::Fuse::Scripting::NativeMember_typeof()->Array();
    ::TYPES[1] = ::g::Fuse::Scripting::NativeMember_typeof();
    ::TYPES[2] = ::g::Fuse::Scripting::NativeCallback_typeof();
    ::TYPES[61] = ::g::Fuse::Scripting::NativeModule_typeof();
    ::TYPES[62] = ::g::Uno::EventHandler_typeof();
    ::TYPES[6] = ::g::Fuse::Scripting::IModule_typeof();
    ::TYPES[4] = ::g::Uno::String_typeof();
    ::TYPES[63] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[5] = uObject_typeof();
    type->SetFields(0,
...
uObject* InterApp::CreateModule()
{
    ...
    module->add_Evaluated(uDelegate::New(::TYPES[62/*Uno.EventHandler*/], (void*)InterApp__OnJsInitialized_fn));
...
void InterApp::OnJsInitialized(uObject* sender, ::g::Uno::EventArgs* args)
{
    ...
    if (InterApp::_cachedUris() != NULL)
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong<uString*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(InterApp::_cachedUris()), &ret3), ret3); enum1.MoveNext(::TYPES[63/*Uno.Collections.List<string>.Enumerator*/]); )
        {
            uString* uri = enum1.Current(::TYPES[63/*Uno.Collections.List<string>.Enumerator*/]);
...
uType* Lifecycle_typeof()
{
    ...
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[59] = ::g::Uno::Platform2::Application_typeof();
    ::TYPES[64] = ::g::Uno::Platform2::ApplicationStateTransitionHandler_typeof();
    type->SetFields(0,
...
uObject* Lifecycle::CreateModule()
{
    ...
    module->add_Evaluated(uDelegate::New(::TYPES[62/*Uno.EventHandler*/], (void*)Lifecycle__OnJsInitialized_fn));
    return (uObject*)module;
}
...
{
    ::g::Uno::Platform2::Application::add_EnteringForeground(uDelegate::New(::TYPES[64/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Lifecycle__OnEnteringForeground_fn));
    ::g::Uno::Platform2::Application::add_EnteringInteractive(uDelegate::New(::TYPES[64/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Lifecycle__OnEnteringInteractive_fn));
    ::g::Uno::Platform2::Application::add_ExitedInteractive(uDelegate::New(::TYPES[64/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Lifecycle__OnExitedInteractive_fn));
    ::g::Uno::Platform2::Application::add_EnteringBackground(uDelegate::New(::TYPES[64/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Lifecycle__OnEnteringBackground_fn));
    ::g::Uno::Platform2::Application::add_Terminating(uDelegate::New(::TYPES[64/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)Lifecycle__OnTerminating_fn));
}
...
{
    double latitude = uUnbox<double>(::TYPES[65/*double*/], uPtr(args)->Strong<uObject*>(0));
    double longitude = uUnbox<double>(::TYPES[65/*double*/], args->Strong<uObject*>(1));
...
uClassType* Storage_typeof()
{
    ...
    ::TYPES[1] = ::g::Fuse::Scripting::NativeMember_typeof();
    ::TYPES[2] = ::g::Fuse::Scripting::NativeCallback_typeof();
    ::TYPES[66] = ::g::Fuse::Scripting::NativePromise_typeof()->MakeType(::g::Uno::Bool_typeof(), ::g::Uno::Bool_typeof());
    ::TYPES[67] = ::g::Fuse::Scripting::FutureFactory_typeof()->MakeType(::g::Uno::Bool_typeof());
    ::TYPES[20] = ::g::Fuse::Scripting::NativePromise_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    ::TYPES[68] = ::g::Fuse::Scripting::FutureFactory_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[4] = ::g::Uno::String_typeof();
    ::TYPES[5] = uObject_typeof();
    return type;
...
{
    return (uObject*)::g::Fuse::Scripting::NativeModule::New1(uArray::Init< ::g::Fuse::Scripting::NativeMember*>(::TYPES[0/*Fuse.Scripting.NativeMember[]*/], 5, (::g::Fuse::Scripting::NativeFunction*)::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[100/*"writeSync"*/], uDelegate::New(::TYPES[2/*Fuse.Scripting.NativeCallback*/], (void*)Storage__Write_fn)), (::g::Fuse::Scripting::NativeFunction*)::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[101/*"readSync"*/], uDelegate::New(::TYPES[2/*Fuse.Scripting.NativeCallback*/], (void*)Storage__Read_fn)), (::g::Fuse::Scripting::NativeFunction*)::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[102/*"deleteSync"*/], uDelegate::New(::TYPES[2/*Fuse.Scripting.NativeCallback*/], (void*)Storage__Delete_fn)), (::g::Fuse::Scripting::NativePromise*)::g::Fuse::Scripting::NativePromise::New1(::TYPES[66/*Fuse.Scripting.NativePromise<bool, bool>*/], ::STRINGS[103/*"write"*/], uDelegate::New(::TYPES[67/*Fuse.Scripting.FutureFactory<bool>*/], (void*)Storage__WriteAsync_fn), NULL), (::g::Fuse::Scripting::NativePromise*)::g::Fuse::Scripting::NativePromise::New1(::TYPES[20/*Fuse.Scripting.NativePromise<string, string>*/], ::STRINGS[104/*"read"*/], uDelegate::New(::TYPES[68/*Fuse.Scripting.FutureFactory<string>*/], (void*)Storage__ReadAsync_fn), NULL)));
}
...
uObject* Storage::Delete(::g::Fuse::Scripting::Context* c, uArray* args)
{
    if (uPtr(args)->Length() > 0)
    {
        ...
        return uBox(::TYPES[38/*bool*/], ::g::Fuse::Storage::ApplicationDir::Delete(filename));
    }

    return uBox(::TYPES[38/*bool*/], false);
}
...
uObject* Storage::Write(::g::Fuse::Scripting::Context* c, uArray* args)
{
    if (uPtr(args)->Length() > 0)
    {
        ...
        return uBox(::TYPES[38/*bool*/], ::g::Fuse::Storage::ApplicationDir::Write((filename != NULL) ? filename : ::STRINGS[105/*""*/], (value != NULL) ? value : ::STRINGS[105/*""*/]));
    }

    return uBox(::TYPES[38/*bool*/], ::g::Fuse::Storage::ApplicationDir::Write(::STRINGS[105/*""*/], ::STRINGS[105/*""*/]));
}
...
uType* TimerManager__Timer_typeof()
{
    ...
    ::TYPES[65] = ::g::Uno::Double_typeof();
    ::TYPES[12] = ::g::Uno::Action_typeof();
    ::TYPES[69] = ::g::Uno::Delegate_typeof();
    ::TYPES[29] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Int_typeof());
    ::TYPES[38] = ::g::Uno::Bool_typeof();
    type->SetFields(0,
...
uObject* TimerModule::Create(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    bool repeat = uUnbox<bool>(::TYPES[38/*bool*/], args->Strong<uObject*>(2));
    uArray* innerArgs = uArray::New(::TYPES[3/*object[]*/], args->Length() - 3);

    for (int i = 0; i < innerArgs->Length(); i++)
        innerArgs->Strong<uObject*>(i) = args->Strong<uObject*>(3 + i);

    return uBox<int>(::TYPES[39/*int*/], uPtr(_tm)->AddTimer(ms, uDelegate::New(::TYPES[12/*Uno.Action*/], (void*)TimerModule__CallbackClosure__Callback_fn, TimerModule__CallbackClosure::New1(context, func, innerArgs)), repeat));
}
