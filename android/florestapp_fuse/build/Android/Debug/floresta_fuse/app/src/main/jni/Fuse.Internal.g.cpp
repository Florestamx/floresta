...
// {
::g::Fuse::Internal::Blender_type* ScalarBlender_typeof()
{
    static uSStrong< ::g::Fuse::Internal::Blender_type*> type;
    if (type != NULL) return type;
    ...
    options.TypeSize = sizeof(::g::Fuse::Internal::Blender_type);
    type = (::g::Fuse::Internal::Blender_type*)uClassType::New("Fuse.Internal.ScalarBlender`1", options);
...
uType* SizingContainer_typeof()
{
    ...
    ::TYPES[1] = ::g::Uno::Bool_typeof();
    ::TYPES[25] = ::g::Uno::Int_typeof();
    ::TYPES[28] = ::g::Fuse::LayoutParams_typeof();
    type->SetFields(0,
