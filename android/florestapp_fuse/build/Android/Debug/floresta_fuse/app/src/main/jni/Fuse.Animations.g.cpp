...
::g::Fuse::Animations::TransformAnimator_type* Rotate_typeof()
{
    ...
    ::TYPES[68] = ::g::Fuse::Rotation_typeof();
    ::TYPES[27] = ::g::Uno::Float4_typeof();
    type->SetFields(20);
    return type;
}
...
::g::Fuse::Animations::TransformAnimator_type* Scale_typeof()
{
    ...
    ::TYPES[69] = ::g::Fuse::ScalingModes_typeof();
    ::TYPES[70] = ::g::Fuse::Animations::TransformAnimator_typeof()->MakeType(::g::Fuse::Scaling_typeof());
    ::TYPES[35] = ::g::Fuse::Animations::TrackAnimator_typeof();
    ::TYPES[71] = ::g::Fuse::Scaling_typeof();
    ::TYPES[27] = ::g::Uno::Float4_typeof();
    type->SetFields(20,
...
::g::Fuse::Animations::OpenAnimatorState_type* SpinState_typeof()
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/0.24.6/$.uno");
    ::TYPES[40] = ::g::Fuse::Animations::OpenAnimator_typeof();
    ::TYPES[73] = ::g::Fuse::Animations::Spin_typeof();
    ::TYPES[31] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[32] = ::g::Fuse::Animations::AnimatorState_typeof();
    ::TYPES[4] = ::g::Uno::Double_typeof();
    ::TYPES[68] = ::g::Fuse::Rotation_typeof();
...
::g::Fuse::Animations::Animator_type* TrackAnimator_typeof()
{
    ...
    ::TYPES[74] = ::g::Fuse::Animations::TrackProvider_typeof();
    ::TYPES[75] = ::g::Fuse::Animations::EasingTrack_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
    ::TYPES[31] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[76] = ::g::Fuse::Animations::DiscreteSingleTrack_typeof();
    type->SetFields(3,
...
void TrackAnimator__get_AnimatorVariant_fn(TrackAnimator* __this, int* __retval)
{
    if (__this->_discreteProvider != NULL)
        return *__retval = ::g::Fuse::Animations::TrackProvider::GetAnimatorVariant(uInterface(uPtr(__this->_discreteProvider), ::TYPES[74/*Fuse.Animations.TrackProvider*/]), __this), void();
    else if (__this->_continuousProvider != NULL)
        return *__retval = ::g::Fuse::Animations::TrackProvider::GetAnimatorVariant(uInterface(uPtr(__this->_continuousProvider), ::TYPES[74/*Fuse.Animations.TrackProvider*/]), __this), void();
...
void TrackAnimator__GetDurationWithDelay_fn(TrackAnimator* __this, int* dir, double* __retval)
{
    ...
    if (__this->_discreteProvider != NULL)
        duration = ::g::Fuse::Animations::TrackProvider::GetDuration(uInterface(uPtr(__this->_discreteProvider), ::TYPES[74/*Fuse.Animations.TrackProvider*/]), __this, dir_);
    else if (__this->_continuousProvider != NULL)
        duration = ::g::Fuse::Animations::TrackProvider::GetDuration(uInterface(uPtr(__this->_continuousProvider), ::TYPES[74/*Fuse.Animations.TrackProvider*/]), __this, dir_);
...
TrackAnimatorState_type* TrackAnimatorState_typeof()
{
    ...
    ::TYPES[32] = ::g::Fuse::Animations::AnimatorState_typeof();
    ::TYPES[45] = ::g::Fuse::Animations::ContinuousTrackProvider_typeof();
    ::TYPES[77] = ::g::Fuse::Animations::DiscreteTrackProvider_typeof();
    ::TYPES[21] = ::g::Uno::Float_typeof();
    ::TYPES[35] = ::g::Fuse::Animations::TrackAnimator_typeof();
    ::TYPES[31] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
...
void TrackAnimatorState__SeekProgress_fn(TrackAnimatorState* __this, double* progress, double* interval, int* dir, double* strength, bool* __retval)
{
    ...
    if (__this->_discreteProvider != NULL)
    {
        double oStrength1;
        uObject* oValue1;
        bool r1 = ::g::Fuse::Animations::DiscreteTrackProvider::GetSeekProgress(uInterface(uPtr(__this->_discreteProvider), ::TYPES[77/*Fuse.Animations.DiscreteTrackProvider*/]), __this, progress_, interval_, dir_, &oValue1, &oStrength1);
...
void TrackAnimatorState__SeekTime_fn(TrackAnimatorState* __this, double* elapsed, double* interval, int* dir, double* strength, bool* __retval)
{
    ...
    if (__this->_discreteProvider != NULL)
    {
        double oStrength1;
        uObject* oValue1;
        bool r1 = ::g::Fuse::Animations::DiscreteTrackProvider::GetSeekTime(uInterface(uPtr(__this->_discreteProvider), ::TYPES[77/*Fuse.Animations.DiscreteTrackProvider*/]), __this, relTime, interval_, dir_, &oValue1, &oStrength1);
...
void TrackAnimatorState::ctor_1(::g::Fuse::Animations::TrackAnimator* animator, ::g::Fuse::Animations::CreateStateParams* p, ::g::Fuse::Node* useNode)
{
    ...
    _discreteProvider = uAs<uObject*>(pr, ::TYPES[77/*Fuse.Animations.DiscreteTrackProvider*/]);
}
...
TransformAnimator_type* TransformAnimator_typeof()
{
    ...
    ::TYPES[31] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[32] = ::g::Fuse::Animations::AnimatorState_typeof();
    ::TYPES[78] = ::g::Fuse::Animations::TransformAnimatorState_typeof();
    ::TYPES[27] = ::g::Uno::Float4_typeof();
    ::TYPES[35] = ::g::Fuse::Animations::TrackAnimator_typeof();
    type->SetPrecalc(
        ::TYPES[78/*Fuse.Animations.TransformAnimatorState`1*/]->MakeType(type->T(0)));
    type->SetFields(17,
...
::g::Fuse::Animations::TrackAnimatorState_type* TransformAnimatorState_typeof()
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/0.24.6/$.uno");
    ::TYPES[35] = ::g::Fuse::Animations::TrackAnimator_typeof();
    ::TYPES[79] = ::g::Fuse::Animations::TransformAnimator_typeof();
    ::TYPES[31] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[32] = ::g::Fuse::Animations::AnimatorState_typeof();
    ::TYPES[80] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ::TYPES[47] = ::g::Fuse::Transform_typeof();
    ::TYPES[9] = ::g::Uno::Bool_typeof();
    type->SetPrecalc(
        ::TYPES[79/*Fuse.Animations.TransformAnimator`1*/]->MakeType(type->T(0)));
    type->SetFields(6,
...
void TransformAnimatorState::ctor_2(::g::Fuse::Animations::TransformAnimator* animator, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    _matAct = uDelegate::New(::TYPES[80/*Uno.Action<Fuse.Transform>*/], (void*)TransformAnimatorState__OnMatrixChanged_fn, this);
...
uType* TriggerAnimation_typeof()
{
    ...
    ::TYPES[1] = ::g::Fuse::Animations::CreateStateParams_typeof();
    ::TYPES[60] = ::g::Fuse::Animations::AnimatorState_typeof()->Array();
    ::TYPES[81] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof());
    ::TYPES[10] = ::g::Uno::Int_typeof();
    ::TYPES[39] = ::g::Uno::Delegate_typeof();
    ::TYPES[50] = ::g::Uno::Action_typeof();
    ::TYPES[9] = ::g::Uno::Bool_typeof();
    ::TYPES[82] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof());
    ::TYPES[31] = ::g::Fuse::Animations::Animator_typeof();
    type->SetFields(0,
...
{
    if (_animators == NULL)
        _animators = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[81/*Uno.Collections.List<Fuse.Animations.Animator>*/]));
...
uType* TriggerAnimationState_typeof()
{
    ...
    ::TYPES[83] = ::g::Fuse::Animations::TriggerAnimation_typeof();
    ::TYPES[50] = ::g::Uno::Action_typeof();
    ::TYPES[9] = ::g::Uno::Bool_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
    ::TYPES[84] = ::g::Fuse::Animations::Player_typeof();
    ::TYPES[39] = ::g::Uno::Delegate_typeof();
    ::TYPES[59] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof());
    ::TYPES[11] = uObject_typeof();
    type->SetFields(0,
...
::g::Fuse::Animations::Player* TriggerAnimationState::GetCurrentPlayer(int tendTo, int flags)
{
    ...
    return uAs< ::g::Fuse::Animations::Player*>(GetPlayer(tendTo, false), ::TYPES[84/*Fuse.Animations.Player*/]);
}
