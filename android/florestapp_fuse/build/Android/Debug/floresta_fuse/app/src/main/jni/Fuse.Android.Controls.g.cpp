...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1264)
// ------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(737)
// -----------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(800)
// -----------------------------------------------------------------------------------------
...
Image__ImageLoader__BitmapLoader_type* Image__ImageLoader__BitmapLoader_typeof()
{
    ...
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno");
    ::TYPES[0] = ::g::Uno::Bool_typeof();
    ::TYPES[1] = ::g::Android::Base::Wrappers::JWrapper_typeof();
    ::TYPES[2] = ::g::Android::Base::Primitives::ujclass_typeof();
    ...
    ::TYPES[11] = ::g::Uno::Action1_typeof()->MakeType(::g::Android::android::graphics::Bitmap_typeof());
    type->SetInterfaces(
...
void Image__ImageLoader__BitmapLoader__AndroidjavalangRunnablerun_fn(Image__ImageLoader__BitmapLoader* __this)
{
    ...
    uPtr(::g::Android::android::app::Activity::GetAppActivity())->runOnUiThread(::g::Android::Runtime::UnoHelper::RunnableFromAction(uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)Image__ImageLoader__BitmapLoader__Done_fn, __this)));
}
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(39)
// ----------------------------------------------------------------------------------------
...
static void Button__cctor_1_fn(uType* __type)
{
    ...
    Button::TextColorProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[12/*Fuse.StyleProperty<Fuse.Android.Controls.Button, float4>*/], uCRef(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f)), uDelegate::New(::TYPES[13/*Uno.Action<Fuse.Android.Controls.Button>*/], (void*)Button__OnButtonPropertyChanged_fn), &ret2), ret2);
}
...
::g::Fuse::Android::Controls::Control_type* Button_typeof()
{
    ...
    ::TYPES[12] = ::g::Fuse::StyleProperty1_typeof()->MakeType(Button_typeof(), ::g::Uno::Float4_typeof());
    ::TYPES[13] = ::g::Uno::Action1_typeof()->MakeType(Button_typeof());
    ::TYPES[14] = ::g::Fuse::Controls::Button_typeof();
    ::TYPES[15] = ::g::Fuse::Android::Controls::Control_typeof()->MakeType(::g::Fuse::Controls::Button_typeof());
    ::TYPES[16] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[17] = ::g::Android::java::lang::Object_typeof();
    ::TYPES[18] = ::g::Android::android::content::Context_typeof();
    ::TYPES[19] = ::g::Android::android::view::View_typeof();
    ::TYPES[20] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[21] = ::g::Android::java::lang::CharSequence_typeof();
    type->SetInterfaces(
...
{
    uPtr((::g::Fuse::Controls::Button*)__this->SemanticControl())->add_TextChanged(uDelegate::New(::TYPES[16/*Uno.UX.ValueChangedHandler<string>*/], (void*)Button__OnTextChanged_fn, __this));
...
{
    uPtr((::g::Fuse::Controls::Button*)__this->SemanticControl())->remove_TextChanged(uDelegate::New(::TYPES[16/*Uno.UX.ValueChangedHandler<string>*/], (void*)Button__OnTextChanged_fn, __this));
}
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(280)
// -----------------------------------------------------------------------------------------
...
::g::Fuse::Android::Controls::CompoundButton_type* CheckBox_typeof()
{
    ...
    type->interface0.fp_FindObjectByName = (void(*)(uObject*, uString*, uDelegate*, uObject**))::g::Fuse::Node__FindObjectByName_fn;
    ::TYPES[22] = ::g::Android::android::widget::CompoundButton_typeof();
    ::TYPES[18] = ::g::Android::android::content::Context_typeof();
    type->SetInterfaces(
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(148)
// -----------------------------------------------------------------------------------------
...
::g::Fuse::Android::Controls::Shape_type* Circle_typeof()
{
    ...
    ::TYPES[24] = ::g::Fuse::Controls::Circle_typeof();
    ::TYPES[25] = ::g::Fuse::Android::Controls::Control_typeof()->MakeType(::g::Fuse::Controls::Circle_typeof());
    ::TYPES[26] = ::g::Android::android::graphics::drawable::shapes::Shape_typeof();
    type->SetInterfaces(
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(198)
// -----------------------------------------------------------------------------------------
...
CompoundButton_type* CompoundButton_typeof()
{
    ...
    type->interface0.fp_FindObjectByName = (void(*)(uObject*, uString*, uDelegate*, uObject**))::g::Fuse::Node__FindObjectByName_fn;
    ::TYPES[27] = ::g::Fuse::Controls::ToggleControl_typeof();
    ::TYPES[28] = ::g::Fuse::Android::Controls::Control_typeof()->MakeType(::g::Fuse::Controls::ToggleControl_typeof());
    ::TYPES[29] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Bool_typeof());
    ::TYPES[19] = ::g::Android::android::view::View_typeof();
    ::TYPES[17] = ::g::Android::java::lang::Object_typeof();
    ::TYPES[30] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::Bool_typeof());
    type->SetInterfaces(
...
{
    uPtr((::g::Fuse::Controls::ToggleControl*)__this->SemanticControl())->add_ValueChanged(uDelegate::New(::TYPES[29/*Uno.UX.ValueChangedHandler<bool>*/], (void*)CompoundButton__OnValueChanged_fn, __this));
    __this->InitValue();
}
...
{
    uPtr((::g::Fuse::Controls::ToggleControl*)__this->SemanticControl())->remove_ValueChanged(uDelegate::New(::TYPES[29/*Uno.UX.ValueChangedHandler<bool>*/], (void*)CompoundButton__OnValueChanged_fn, __this));
}
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(318)
// -----------------------------------------------------------------------------------------
...
Control_type* Control_typeof()
{
    ...
    ::TYPES[17] = ::g::Android::java::lang::Object_typeof();
    ::TYPES[31] = ::g::Fuse::Android::FocusChangedHandler_typeof();
    ::TYPES[32] = ::g::Fuse::Node_typeof();
    ::TYPES[0] = ::g::Uno::Bool_typeof();
    ::TYPES[33] = ::g::Fuse::Android::Controls::FocusManager_typeof();
    ::TYPES[34] = ::g::Android::android::view::inputmethod::InputMethodManager_typeof();
    ::TYPES[18] = ::g::Android::android::content::Context_typeof();
    ::TYPES[35] = uObject_typeof();
    ::TYPES[36] = ::g::Fuse::Input::Focus_typeof();
...
void Control__Create_fn(Control* __this, ::g::Android::android::view::View** __retval)
{
    ...
    ::g::Fuse::Android::FocusChangedListener::AddHandler(__this->_view, uDelegate::New(::TYPES[31/*Fuse.Android.FocusChangedHandler*/], (void*)Control__OnNativeFocusChanged_fn, __this));
    return *__retval = __this->_view, void();
}
...
void Control__OnRooted_fn(Control* __this)
{
    ...
    ::g::Fuse::NodeEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this, uDelegate::New(::TYPES[37/*Fuse.Input.FocusGainedHandler*/], (void*)Control__OnGotFocus_fn, __this));
    ::g::Fuse::NodeEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this, uDelegate::New(::TYPES[38/*Fuse.Input.FocusLostHandler*/], (void*)Control__OnLostFocus_fn, __this));
    __this->Attach();
}
...
{
    ::g::Fuse::NodeEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this, uDelegate::New(::TYPES[37/*Fuse.Input.FocusGainedHandler*/], (void*)Control__OnGotFocus_fn, __this));
    ::g::Fuse::NodeEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this, uDelegate::New(::TYPES[38/*Fuse.Input.FocusLostHandler*/], (void*)Control__OnLostFocus_fn, __this));
    __this->Detach();
...
void Control::OnNativeFocusChanged(uObject* s, bool hasFocus)
{
    ...
    else
    {
        ...
        if (ShowKeyboard())
        {
            ...
            ::g::Android::android::view::inputmethod::InputMethodManager* imm = uCast< ::g::Android::android::view::inputmethod::InputMethodManager*>(uPtr(uPtr(_view)->getContext())->getSystemService(::g::Android::android::content::Context::INPUT_METHOD_SERVICE()), ::TYPES[34/*Android.android.view.inputmethod.InputMethodManager*/]);
...
void Control::ScheduleFocusLoss()
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)::g::Fuse::Android::Controls::FocusManager__CompleteFocusLoss_fn, uPtr(::g::Fuse::Android::Controls::FocusManager::Singleton())), -1);
}
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(530)
// -----------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(535)
// -----------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(537)
// -----------------------------------------------------------------------------------------
...
EditorActionListener_type* EditorActionListener_typeof()
{
    ...
    ::TYPES[1] = ::g::Android::Base::Wrappers::JWrapper_typeof();
    ::TYPES[2] = ::g::Android::Base::Primitives::ujclass_typeof();
    ::TYPES[39] = ::g::Android::android::widget::TextViewDLROnEditorActionListener_typeof();
    ::TYPES[40] = ::g::Uno::IDisposable_typeof();
    ::TYPES[10] = ::g::Uno::Delegate_typeof();
    ::TYPES[41] = ::g::Fuse::Android::Controls::EditorActionArgs_typeof();
    ::TYPES[42] = ::g::Fuse::Android::Controls::EditorActionHandler_typeof();
    ::TYPES[35] = uObject_typeof();
    type->SetInterfaces(
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(606)
// -----------------------------------------------------------------------------------------
...
Element_type* Element_typeof()
{
    ...
    type->interface0.fp_FindObjectByName = (void(*)(uObject*, uString*, uDelegate*, uObject**))::g::Fuse::Node__FindObjectByName_fn;
    ::TYPES[32] = ::g::Fuse::Node_typeof();
    ::TYPES[43] = ::g::Fuse::Behavior_typeof();
    ::TYPES[44] = ::g::Fuse::IViewport_typeof();
    ::TYPES[45] = ::g::Uno::Int_typeof();
    ::TYPES[46] = ::g::Fuse::LayoutParams_typeof();
    ::TYPES[47] = ::g::Android::android::view::ViewDLRMeasureSpec_typeof();
    ::TYPES[48] = ::g::Fuse::Android::NativeViews::NativeView_typeof();
    ::TYPES[49] = ::g::Uno::Float_typeof();
    ::TYPES[0] = ::g::Uno::Bool_typeof();
    ::TYPES[23] = ::g::Uno::Float2_typeof();
    ::TYPES[50] = ::g::Uno::Float4_typeof();
    ::TYPES[9] = ::g::Uno::Action_typeof();
    ::TYPES[51] = ::g::Fuse::HitTestContext_typeof();
    type->SetInterfaces(
...
void Element__GetMarginSize_fn(Element* __this, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    float density = ::g::Fuse::IViewport::PointDensity(uInterface(uPtr(__this->Viewport()), ::TYPES[44/*Fuse.IViewport*/]));
...
void Element__OnArrangeMarginBox_fn(Element* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)::g::Fuse::Android::NativeViews::NativeView__NotifyNewTransform_fn, uPtr(__this->NativeView())), -1);
...
{
    ctor_();
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Behaviors()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[43/*Fuse.Behavior*/])), ::g::Fuse::Android::NativeViews::LeafNativeView::New1());
}
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(416)
// -----------------------------------------------------------------------------------------
...
void FocusManager::CompleteFocusLoss()
{
    ...
    {
        ::g::Android::android::view::inputmethod::InputMethodManager* imm = uCast< ::g::Android::android::view::inputmethod::InputMethodManager*>(uPtr(HideKeyboardContext)->getSystemService(::g::Android::android::content::Context::INPUT_METHOD_SERVICE()), ::TYPES[34/*Android.android.view.inputmethod.InputMethodManager*/]);
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(796)
// -----------------------------------------------------------------------------------------
...
::g::Fuse::Android::Controls::Control_type* Image_typeof()
{
    ...
    type->interface0.fp_FindObjectByName = (void(*)(uObject*, uString*, uDelegate*, uObject**))::g::Fuse::Node__FindObjectByName_fn;
    ::TYPES[52] = ::g::Fuse::Controls::Image_typeof();
    ::TYPES[53] = ::g::Fuse::Android::Controls::Control_typeof()->MakeType(::g::Fuse::Controls::Image_typeof());
    ::TYPES[54] = ::g::Uno::EventHandler_typeof();
    ::TYPES[17] = ::g::Android::java::lang::Object_typeof();
    ::TYPES[18] = ::g::Android::android::content::Context_typeof();
    ::TYPES[55] = ::g::Android::android::widget::ImageViewDLRScaleType_typeof();
    ::TYPES[56] = ::g::Android::android::view::ViewGroupDLRLayoutParams_typeof();
    ::TYPES[19] = ::g::Android::android::view::View_typeof();
    ::TYPES[57] = ::g::Android::Runtime::FloatArray_typeof();
    ::TYPES[23] = ::g::Uno::Float2_typeof();
    ::TYPES[58] = ::g::Fuse::Internal::SizingContainer_typeof();
    ::TYPES[32] = ::g::Fuse::Node_typeof();
    ::TYPES[47] = ::g::Android::android::view::ViewDLRMeasureSpec_typeof();
    ::TYPES[49] = ::g::Uno::Float_typeof();
    ::TYPES[46] = ::g::Fuse::LayoutParams_typeof();
    ::TYPES[44] = ::g::Fuse::IViewport_typeof();
    ::TYPES[59] = ::g::Fuse::Android::Controls::Element_typeof();
    ::TYPES[9] = ::g::Uno::Action_typeof();
    ::TYPES[60] = ::g::Fuse::Resources::FileImageSource_typeof();
    ::TYPES[61] = ::g::Fuse::Resources::HttpImageSource_typeof();
    ::TYPES[45] = ::g::Uno::Int_typeof();
    ::TYPES[62] = ::g::Android::android::os::BuildDLRVERSION_typeof();
    type->SetInterfaces(
        ::g::Fuse::Scripting::INameScope_typeof(), offsetof(::g::Fuse::Android::Controls::Control_type, interface0));
    type->SetFields(59,
...
{
    __this->Create();
    uPtr((::g::Fuse::Controls::Image*)__this->SemanticControl())->add_ParamChanged(uDelegate::New(::TYPES[54/*Uno.EventHandler*/], (void*)Image__OnParamChanged_fn, __this));
    uPtr((::g::Fuse::Controls::Image*)__this->SemanticControl())->add_SourceChanged(uDelegate::New(::TYPES[54/*Uno.EventHandler*/], (void*)Image__OnSourceChanged_fn, __this));
...
{
    uPtr((::g::Fuse::Controls::Image*)__this->SemanticControl())->remove_ParamChanged(uDelegate::New(::TYPES[54/*Uno.EventHandler*/], (void*)Image__OnParamChanged_fn, __this));
    uPtr((::g::Fuse::Controls::Image*)__this->SemanticControl())->remove_SourceChanged(uDelegate::New(::TYPES[54/*Uno.EventHandler*/], (void*)Image__OnSourceChanged_fn, __this));
}
...
void Image::OnSourceChanged(uObject* sender, ::g::Uno::EventArgs* args)
{
    ...
    ::g::Fuse::Resources::FileImageSource* fs = uAs< ::g::Fuse::Resources::FileImageSource*>(uPtr((::g::Fuse::Controls::Image*)SemanticControl())->Source(), ::TYPES[60/*Fuse.Resources.FileImageSource*/]);
    ...
    ::g::Fuse::Resources::HttpImageSource* http = uAs< ::g::Fuse::Resources::HttpImageSource*>(uPtr((::g::Fuse::Controls::Image*)SemanticControl())->Source(), ::TYPES[61/*Fuse.Resources.HttpImageSource*/]);
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(798)
// -----------------------------------------------------------------------------------------
...
uType* Image__ImageLoader_typeof()
{
    ...
    ::TYPES[11] = ::g::Uno::Action1_typeof()->MakeType(::g::Android::android::graphics::Bitmap_typeof());
    ::TYPES[63] = ::g::Android::java::lang::Runnable_typeof();
    ::TYPES[17] = ::g::Android::java::lang::Object_typeof();
    ::TYPES[64] = ::g::Fuse::Android::Controls::Image_typeof();
    type->SetFields(0,
...
{
    _image = image;
    _loader = Image__ImageLoader__BitmapLoader::New5(url, uDelegate::New(::TYPES[11/*Uno.Action<Android.android.graphics.Bitmap>*/], (void*)Image__ImageLoader__OnDone_fn, this));
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1999)
// ------------------------------------------------------------------------------------------
...
JsResultHandler_type* JsResultHandler_typeof()
{
    ...
    ::TYPES[66] = ::g::Android::java::lang::String_typeof();
    type->SetInterfaces(
...
void JsResultHandler::update(::g::Android::java::util::Observable* observable, ::g::Android::java::lang::Object* data)
{
    if (::g::Uno::Delegate::op_Inequality(Callback, NULL))
        uPtr(Callback)->InvokeVoid(::g::Android::java::lang::String::op_Implicit(uCast< ::g::Android::java::lang::String*>(data, ::TYPES[66/*Android.java.lang.String*/])));
}
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(203)
// -----------------------------------------------------------------------------------------
...
CompoundButton__Listener_type* CompoundButton__Listener_typeof()
{
    ...
    ::TYPES[1] = ::g::Android::Base::Wrappers::JWrapper_typeof();
    ::TYPES[2] = ::g::Android::Base::Primitives::ujclass_typeof();
    ::TYPES[67] = ::g::Fuse::Android::Controls::CompoundButton_typeof();
    ::TYPES[68] = ::g::Android::android::widget::CompoundButtonDLROnCheckedChangeListener_typeof();
    ::TYPES[28] = ::g::Fuse::Android::Controls::Control_typeof()->MakeType(::g::Fuse::Controls::ToggleControl_typeof());
    ::TYPES[35] = uObject_typeof();
    type->SetInterfaces(
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1176)
// ------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1801)
// ------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1364)
// ------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1366)
// ------------------------------------------------------------------------------------------
...
ProgressChangedListener_type* ProgressChangedListener_typeof()
{
    ...
    ::TYPES[1] = ::g::Android::Base::Wrappers::JWrapper_typeof();
    ::TYPES[2] = ::g::Android::Base::Primitives::ujclass_typeof();
    ::TYPES[69] = ::g::Android::android::widget::SeekBarDLROnSeekBarChangeListener_typeof();
    ::TYPES[40] = ::g::Uno::IDisposable_typeof();
    ::TYPES[10] = ::g::Uno::Delegate_typeof();
    ::TYPES[70] = ::g::Fuse::Android::Controls::ProgressChangedHandler_typeof();
    ::TYPES[35] = uObject_typeof();
    type->SetInterfaces(
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(289)
// -----------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1214)
// ------------------------------------------------------------------------------------------
...
::g::Fuse::Android::Controls::Shape_type* Rectangle_typeof()
{
    ...
    ::TYPES[44] = ::g::Fuse::IViewport_typeof();
    ::TYPES[32] = ::g::Fuse::Node_typeof();
    ::TYPES[71] = ::g::Fuse::Android::Controls::Control_typeof()->MakeType(::g::Fuse::Controls::Rectangle_typeof());
    ::TYPES[72] = ::g::Fuse::Controls::Rectangle_typeof();
    ::TYPES[17] = ::g::Android::java::lang::Object_typeof();
    ::TYPES[57] = ::g::Android::Runtime::FloatArray_typeof();
    ::TYPES[50] = ::g::Uno::Float4_typeof();
    ::TYPES[26] = ::g::Android::android::graphics::drawable::shapes::Shape_typeof();
...
void Rectangle__UpdateShapeDrawable_fn(Rectangle* __this, ::g::Android::android::graphics::drawable::ShapeDrawable* shape)
{
    ...
    float ind3;
    float ind4;
    float density = ::g::Fuse::IViewport::PointDensity(uInterface(uPtr(uPtr((::g::Fuse::Controls::Rectangle*)__this->SemanticControl())->Viewport()), ::TYPES[44/*Fuse.IViewport*/]));
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1281)
// ------------------------------------------------------------------------------------------
...
::g::Fuse::Android::Controls::Control_type* SeekBar_typeof()
{
    ...
    type->interface0.fp_FindObjectByName = (void(*)(uObject*, uString*, uDelegate*, uObject**))::g::Fuse::Node__FindObjectByName_fn;
    ::TYPES[73] = ::g::Fuse::Controls::RangeControl_typeof();
    ::TYPES[74] = ::g::Fuse::Android::Controls::Control_typeof()->MakeType(::g::Fuse::Controls::Slider_typeof());
    ::TYPES[75] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Double_typeof());
    ::TYPES[70] = ::g::Fuse::Android::Controls::ProgressChangedHandler_typeof();
    ::TYPES[17] = ::g::Android::java::lang::Object_typeof();
    ::TYPES[76] = ::g::Android::android::widget::SeekBar_typeof();
    ::TYPES[18] = ::g::Android::android::content::Context_typeof();
    ::TYPES[3] = ::g::Uno::Func1_typeof()->MakeType(::g::Android::android::view::MotionEvent_typeof(), ::g::Uno::Bool_typeof());
    ::TYPES[19] = ::g::Android::android::view::View_typeof();
    ::TYPES[77] = ::g::Uno::Double_typeof();
    ::TYPES[35] = uObject_typeof();
    ::TYPES[32] = ::g::Fuse::Node_typeof();
    ::TYPES[9] = ::g::Uno::Action_typeof();
    ::TYPES[78] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::Double_typeof());
    ::TYPES[45] = ::g::Uno::Int_typeof();
    type->SetInterfaces(
        ::g::Fuse::Scripting::INameScope_typeof(), offsetof(::g::Fuse::Android::Controls::Control_type, interface0));
    type->SetFields(59,
...
{
    __this->Create();
    uPtr((::g::Fuse::Controls::Slider*)__this->SemanticControl())->add_ValueChanged(uDelegate::New(::TYPES[75/*Uno.UX.ValueChangedHandler<double>*/], (void*)SeekBar__OnValueChanged_fn, __this));
    __this->_progressChangedEvent = ::g::Fuse::Android::Controls::ProgressChangedListener::AddHandler(__this->_seekBar, uDelegate::New(::TYPES[70/*Fuse.Android.Controls.ProgressChangedHandler*/], (void*)SeekBar__OnSeekBarProgressChanged_fn, __this));
...
{
    uPtr((::g::Fuse::Controls::Slider*)__this->SemanticControl())->remove_ValueChanged(uDelegate::New(::TYPES[75/*Uno.UX.ValueChangedHandler<double>*/], (void*)SeekBar__OnValueChanged_fn, __this));
    ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_progressChangedEvent), ::TYPES[40/*Uno.IDisposable*/]));
}
    ...
    switch (action)
    {
        ...
        case 5:
        {
            if (_index == -1)
            {
                ...
                ::g::Fuse::Input::Pointer::HardCapture(_index, this, this, uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)SeekBar__LostCallback_fn, this));
            }
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1434)
// ------------------------------------------------------------------------------------------
...
Shape_type* Shape_typeof()
{
    ...
    ::STRINGS[8] = uString::Const("");
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno");
    ::STRINGS[17] = uString::Const("SetBrush");
    ::TYPES[79] = ::g::Fuse::Controls::Shape_typeof();
    ::TYPES[80] = ::g::Fuse::Android::Controls::Control_typeof();
    ::TYPES[9] = ::g::Uno::Action_typeof();
    ::TYPES[18] = ::g::Android::android::content::Context_typeof();
    ::TYPES[81] = ::g::Android::android::graphics::drawable::ShapeDrawable_typeof();
    ::TYPES[17] = ::g::Android::java::lang::Object_typeof();
    ::TYPES[82] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[83] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[84] = ::g::Android::Runtime::ObjectArray_typeof()->MakeType(::g::Android::android::graphics::drawable::Drawable_typeof());
    ::TYPES[85] = ::g::Android::android::graphics::drawable::Drawable_typeof();
    ::TYPES[62] = ::g::Android::android::os::BuildDLRVERSION_typeof();
    ::TYPES[86] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[87] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[88] = ::g::Fuse::Drawing::SolidColor_typeof();
    ::TYPES[89] = ::g::Fuse::Drawing::StaticSolidColor_typeof();
    ::TYPES[35] = uObject_typeof();
    ::TYPES[45] = ::g::Uno::Int_typeof();
    ::TYPES[50] = ::g::Uno::Float4_typeof();
    ::TYPES[90] = ::g::Fuse::Drawing::Stroke_typeof();
    ::TYPES[91] = ::g::Android::android::graphics::PaintDLRStyle_typeof();
    ::TYPES[44] = ::g::Fuse::IViewport_typeof();
    ::TYPES[32] = ::g::Fuse::Node_typeof();
    type->SetPrecalc(
        ::TYPES[80/*Fuse.Android.Controls.Control`1*/]->MakeType(type->T(0)));
    type->SetInterfaces(
...
void Shape__Attach_fn(Shape* __this)
{
    ...
    uPtr((::g::Fuse::Controls::Shape*)__this->SemanticControl())->add_ShapeChanged(uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)Shape__OnShapeChanged_fn, __this));
...
void Shape__Detach_fn(Shape* __this)
{
    ...
    uPtr((::g::Fuse::Controls::Shape*)__this->SemanticControl())->remove_ShapeChanged(uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)Shape__OnShapeChanged_fn, __this));
}
...
{
    return uAs< ::g::Android::android::graphics::drawable::ShapeDrawable*>(uPtr(_drawable)->getDrawable(index), ::TYPES[81/*Android.android.graphics.drawable.ShapeDrawable*/]);
}
...
void Shape::OnShapeChanged()
{
    ...
    int layerCount = (uPtr((::g::Fuse::Controls::Shape*)SemanticControl())->HasFills() ? ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr((::g::Fuse::Controls::Shape*)SemanticControl())->Fills()), ::TYPES[82/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/])) : 0) + (uPtr((::g::Fuse::Controls::Shape*)SemanticControl())->HasStrokes() ? ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr((::g::Fuse::Controls::Shape*)SemanticControl())->Strokes()), ::TYPES[83/*Uno.Collections.ICollection<Fuse.Drawing.Stroke>*/])) : 0);

    if (::g::Android::java::lang::Object::op_Equality1(_drawable, NULL) || (layerCount != uPtr(_drawable)->getNumberOfLayers()))
    {
        ::g::Android::Runtime::ObjectArray* list = (::g::Android::Runtime::ObjectArray*)::g::Android::Runtime::ObjectArray::New6(::TYPES[84/*Android.Runtime.ObjectArray<Android.android.graphics.drawable.Drawable>*/], layerCount);
    ...
    if (uPtr((::g::Fuse::Controls::Shape*)SemanticControl())->HasFills())
    {
        ...
        for (int i2 = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(fills), ::TYPES[82/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/])) - 1; i2 >= 0; --i2)
            SetBrush(GetLayer(layer++), (::g::Uno::Collections::IList::get_Item_ex(uInterface(fills, ::TYPES[86/*Uno.Collections.IList<Fuse.Drawing.Brush>*/]), uCRef<int>(i2), &ret1), ret1));
    }
    ...
    if (uPtr((::g::Fuse::Controls::Shape*)SemanticControl())->HasStrokes())
    {
        ...
        for (int i3 = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(strokes), ::TYPES[83/*Uno.Collections.ICollection<Fuse.Drawing.Stroke>*/])) - 1; i3 >= 0; --i3)
            SetStroke(GetLayer(layer++), (::g::Uno::Collections::IList::get_Item_ex(uInterface(strokes, ::TYPES[87/*Uno.Collections.IList<Fuse.Drawing.Stroke>*/]), uCRef<int>(i3), &ret2), ret2));
    }
}
...
void Shape::SetBrush(::g::Android::android::graphics::drawable::ShapeDrawable* drawable, ::g::Fuse::Drawing::Brush* brush)
{
    ...
    ::g::Fuse::Drawing::SolidColor* sc = uAs< ::g::Fuse::Drawing::SolidColor*>(brush, ::TYPES[88/*Fuse.Drawing.SolidColor*/]);

    if (sc != NULL)
        c = uPtr(sc)->Color();

    ::g::Fuse::Drawing::StaticSolidColor* ssc = uAs< ::g::Fuse::Drawing::StaticSolidColor*>(brush, ::TYPES[89/*Fuse.Drawing.StaticSolidColor*/]);

    if (ssc != NULL)
        c = uPtr(ssc)->Color();

    if ((sc == NULL) && (ssc == NULL))
        ::g::Fuse::Diagnostics::Unsupported(::STRINGS[8/*""*/], brush, ::STRINGS[7/*"/usr/local/...*/], 1477, ::STRINGS[17/*"SetBrush"*/]);
...
void Shape::SetStroke(::g::Android::android::graphics::drawable::ShapeDrawable* drawable, ::g::Fuse::Drawing::Stroke* stroke)
{
    ...
    p->setStrokeWidth(stroke->Width() * ::g::Fuse::IViewport::PointDensity(uInterface(uPtr(uPtr((::g::Fuse::Controls::Shape*)SemanticControl())->Viewport()), ::TYPES[44/*Fuse.IViewport*/])));
}
// }

// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(271)
// -----------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1545)
// ------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1547)
// ------------------------------------------------------------------------------------------
...
TextChangedListener_type* TextChangedListener_typeof()
{
    ...
    type->interface0.fp__GetJavaObject = (void(*)(uObject*, jobject*))::g::Android::Base::Wrappers::JWrapper___GetJavaObject_fn;
    type->interface0.fp__IsSubclassed = (void(*)(uObject*, bool*))::g::Android::Base::Wrappers::JWrapper___IsSubclassed_fn;
    ::STRINGS[18] = uString::Const("com.Bindings.Binding_Fuse_Android_Controls_TextChangedListener");
    ::STRINGS[1] = uString::Const("<init>");
    ::STRINGS[5] = uString::Const("(J)V");
    ::STRINGS[8] = uString::Const("");
    ::TYPES[0] = ::g::Uno::Bool_typeof();
    ::TYPES[1] = ::g::Android::Base::Wrappers::JWrapper_typeof();
    ::TYPES[2] = ::g::Android::Base::Primitives::ujclass_typeof();
    ::TYPES[92] = ::g::Android::android::text::TextWatcher_typeof();
    ::TYPES[40] = ::g::Uno::IDisposable_typeof();
    ::TYPES[10] = ::g::Uno::Delegate_typeof();
    ::TYPES[93] = ::g::Fuse::Android::Controls::TextChangedHandler_typeof();
    ::TYPES[35] = uObject_typeof();
    type->SetInterfaces(
...
{
    if (::g::Uno::Delegate::op_Inequality(__this->_handler, NULL))
        uPtr(__this->_handler)->Invoke(2, (::g::Android::android::widget::TextView*)__this->_textView, (cs != NULL) ? (uString*)::g::Android::java::lang::String::op_Implicit(::g::Android::java::lang::CharSequence::toString(uInterface(uPtr(cs), ::TYPES[21/*Android.java.lang.CharSequence*/]))) : ::STRINGS[8/*""*/]);
}
...
void TextChangedListener::ctor_5(::g::Android::android::widget::TextView* textView, uDelegate* handler)
{
    ...
    {
        _subclassed = true;
        _javaClassName = ::STRINGS[18/*"com.Binding...*/];
    }
    ...
    {
        TextChangedListener::_javaClass2() = ::g::Android::Base::JNI::LocalToGlobalRef(::g::Android::Base::JNI::LoadClass3(::STRINGS[18/*"com.Binding...*/], false));
        JniHelper jni;
        BEGIN_REG_MTD(3);
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1611)
// ------------------------------------------------------------------------------------------
...
TextEdit_type* TextEdit_typeof()
{
    ...
    type->interface0.fp_FindObjectByName = (void(*)(uObject*, uString*, uDelegate*, uObject**))::g::Fuse::Node__FindObjectByName_fn;
    ::STRINGS[19] = uString::Const("android.widget.TextView");
    ::STRINGS[20] = uString::Const("mCursorDrawableRes");
    ::STRINGS[21] = uString::Const("mEditor");
    ::STRINGS[22] = uString::Const("mCursorDrawable");
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno");
    ::TYPES[32] = ::g::Fuse::Node_typeof();
    ::TYPES[42] = ::g::Fuse::Android::Controls::EditorActionHandler_typeof();
    ::TYPES[17] = ::g::Android::java::lang::Object_typeof();
    ::TYPES[94] = ::g::Android::android::widget::TextView_typeof();
    ::TYPES[18] = ::g::Android::android::content::Context_typeof();
    ::TYPES[95] = ::g::Android::Base::Versions_typeof();
    ::TYPES[46] = ::g::Fuse::LayoutParams_typeof();
    ::TYPES[44] = ::g::Fuse::IViewport_typeof();
    ::TYPES[96] = ::g::Fuse::Controls::TextControl_typeof();
    ::TYPES[97] = ::g::Fuse::Android::Controls::Control_typeof()->MakeType(::g::Fuse::Controls::TextEdit_typeof());
    ::TYPES[49] = ::g::Uno::Float_typeof();
    ::TYPES[98] = ::g::Fuse::Android::TextControlLayout_typeof();
    ::TYPES[41] = ::g::Fuse::Android::Controls::EditorActionArgs_typeof();
    ::TYPES[99] = ::g::Fuse::Controls::TextEdit_typeof();
    ::TYPES[21] = ::g::Android::java::lang::CharSequence_typeof();
    ::TYPES[84] = ::g::Android::Runtime::ObjectArray_typeof()->MakeType(::g::Android::android::graphics::drawable::Drawable_typeof());
    ::TYPES[100] = ::g::Android::android::graphics::PorterDuffDLRMode_typeof();
    ::TYPES[35] = uObject_typeof();
    type->SetInterfaces(
...
void TextEdit__Attach_fn(TextEdit* __this)
{
    ...
    __this->_editorActionEvent = ::g::Fuse::Android::Controls::EditorActionListener::AddHandler(__this->_textView1, uDelegate::New(::TYPES[42/*Fuse.Android.Controls.EditorActionHandler*/], (void*)TextEdit__OnEditorAction_fn, __this));
}
...
{
    ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_editorActionEvent), ::TYPES[40/*Uno.IDisposable*/]));
...
void TextEdit__GetMarginSize_fn(TextEdit* __this, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    float wrapWidth = lp_.HasX() ? ::g::Uno::Math::Max1(lp_.X() * ::g::Fuse::IViewport::PointDensity(uInterface(uPtr(__this->Viewport()), ::TYPES[44/*Fuse.IViewport*/])), 0.0f) : FLT_INF;
    uPtr(__this->_textLayout)->Measure((::g::Fuse::Controls::TextEdit*)__this->SemanticControl(), wrapWidth);
    return *__retval = ::g::Uno::Float2__op_Division1(::g::Uno::Float2__New2((float)uPtr(uPtr(__this->_textLayout)->Layout())->getWidth(), (float)uPtr(uPtr(__this->_textLayout)->Layout())->getHeight()), ::g::Fuse::IViewport::PointDensity(uInterface(uPtr(__this->Viewport()), ::TYPES[44/*Fuse.IViewport*/]))), void();
}
...
void TextEdit::SetCursorDrawableColor(int color)
{
    try
    {
        ::g::Android::java::lang::Class* textViewClass = ::g::Android::java::lang::Class::forName(::g::Android::java::lang::String::op_Implicit1(::STRINGS[19/*"android.wid...*/]));
        ::g::Android::java::lang::reflect::Field* fCursorDrawableRes = uPtr(textViewClass)->getDeclaredField(::g::Android::java::lang::String::op_Implicit1(::STRINGS[20/*"mCursorDraw...*/]));
        uPtr(fCursorDrawableRes)->setAccessible1(true);
        int mCursorDrawableRes = fCursorDrawableRes->getInt(_textView1);
        ::g::Android::java::lang::reflect::Field* fEditor = textViewClass->getDeclaredField(::g::Android::java::lang::String::op_Implicit1(::STRINGS[21/*"mEditor"*/]));
        uPtr(fEditor)->setAccessible1(true);
        ::g::Android::java::lang::Object* editor = fEditor->get(_textView1);
        ::g::Android::java::lang::reflect::Field* fCursorDrawable = uPtr(uPtr(editor)->getClass())->getDeclaredField(::g::Android::java::lang::String::op_Implicit1(::STRINGS[22/*"mCursorDraw...*/]));
        uPtr(fCursorDrawable)->setAccessible1(true);
        ::g::Android::Runtime::ObjectArray* r = (::g::Android::Runtime::ObjectArray*)::g::Android::Runtime::ObjectArray::New6(::TYPES[84/*Android.Runtime.ObjectArray<Android.android.graphics.drawable.Drawable>*/], 2);
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1965)
// ------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(1834)
// ------------------------------------------------------------------------------------------
...
TextViewBase_type* TextViewBase_typeof()
{
    ...
    ::STRINGS[8] = uString::Const("");
    ::TYPES[35] = uObject_typeof();
    ::TYPES[101] = ::g::Uno::EventArgs_typeof();
    ::TYPES[96] = ::g::Fuse::Controls::TextControl_typeof();
    ::TYPES[80] = ::g::Fuse::Android::Controls::Control_typeof();
    ::TYPES[54] = ::g::Uno::EventHandler_typeof();
    ::TYPES[16] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::String_typeof());
    ...
    ::TYPES[19] = ::g::Android::android::view::View_typeof();
    ::TYPES[0] = ::g::Uno::Bool_typeof();
    ::TYPES[102] = ::g::Android::android::graphics::Typeface_typeof();
    ::TYPES[103] = ::g::Android::android::util::TypedValue_typeof();
    ::TYPES[44] = ::g::Fuse::IViewport_typeof();
    ::TYPES[32] = ::g::Fuse::Node_typeof();
    ::TYPES[62] = ::g::Android::android::os::BuildDLRVERSION_typeof();
    ::TYPES[104] = ::g::Android::android::view::Gravity_typeof();
    ::TYPES[20] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[21] = ::g::Android::java::lang::CharSequence_typeof();
    type->SetPrecalc(
        ::TYPES[80/*Fuse.Android.Controls.Control`1*/]->MakeType(type->T(0)));
...
void TextViewBase__Attach_fn(TextViewBase* __this)
{
    ...
    __this->SetText();
    uPtr((::g::Fuse::Controls::TextControl*)__this->SemanticControl())->add_TextLayoutPropertyChanged(uDelegate::New(::TYPES[54/*Uno.EventHandler*/], __this, offsetof(TextViewBase_type, fp_OnTextLayoutPropertyChanged)));
    uPtr((::g::Fuse::Controls::TextControl*)__this->SemanticControl())->add_TextRenderPropertyChanged(uDelegate::New(::TYPES[54/*Uno.EventHandler*/], __this, offsetof(TextViewBase_type, fp_OnTextRenderPropertyChanged)));
    uPtr((::g::Fuse::Controls::TextControl*)__this->SemanticControl())->add_ValueChanged(uDelegate::New(::TYPES[16/*Uno.UX.ValueChangedHandler<string>*/], (void*)TextViewBase__OnValueChanged_fn, __this));
    __this->_textChangedEvent = ::g::Fuse::Android::Controls::TextChangedListener::AddHandler(__this->_textView, uDelegate::New(::TYPES[93/*Fuse.Android.Controls.TextChangedHandler*/], (void*)TextViewBase__OnTextChanged_fn, __this));
}
...
void TextViewBase__Detach_fn(TextViewBase* __this)
{
    ...
    uPtr((::g::Fuse::Controls::TextControl*)__this->SemanticControl())->remove_TextLayoutPropertyChanged(uDelegate::New(::TYPES[54/*Uno.EventHandler*/], __this, offsetof(TextViewBase_type, fp_OnTextLayoutPropertyChanged)));
    uPtr((::g::Fuse::Controls::TextControl*)__this->SemanticControl())->remove_TextRenderPropertyChanged(uDelegate::New(::TYPES[54/*Uno.EventHandler*/], __this, offsetof(TextViewBase_type, fp_OnTextRenderPropertyChanged)));
    uPtr((::g::Fuse::Controls::TextControl*)__this->SemanticControl())->remove_ValueChanged(uDelegate::New(::TYPES[16/*Uno.UX.ValueChangedHandler<string>*/], (void*)TextViewBase__OnValueChanged_fn, __this));
    ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_textChangedEvent), ::TYPES[40/*Uno.IDisposable*/]));
}
...
void TextViewBase__OnTextLayoutPropertyChanged_fn(TextViewBase* __this, uObject* sender, ::g::Uno::EventArgs* args)
{
    ...
    uPtr(__this->_textView)->setLineSpacing(uPtr((::g::Fuse::Controls::TextControl*)__this->SemanticControl())->LineSpacing() * ::g::Fuse::IViewport::PointDensity(uInterface(uPtr(uPtr((::g::Fuse::Controls::TextControl*)__this->SemanticControl())->Viewport()), ::TYPES[44/*Fuse.IViewport*/])), 1.0f);
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(298)
// -----------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(2208)
// ------------------------------------------------------------------------------------------
...
::g::Android::android::webkit::WebChromeClient_type* WebChromeClient_typeof()
{
    ...
    type->interface0.fp__GetJavaObject = (void(*)(uObject*, jobject*))::g::Android::Base::Wrappers::JWrapper___GetJavaObject_fn;
    type->interface0.fp__IsSubclassed = (void(*)(uObject*, bool*))::g::Android::Base::Wrappers::JWrapper___IsSubclassed_fn;
    ::STRINGS[23] = uString::Const("com.Bindings.Binding_Fuse_Android_Controls_WebChromeClient");
    ::STRINGS[1] = uString::Const("<init>");
    ::STRINGS[5] = uString::Const("(J)V");
    ::TYPES[0] = ::g::Uno::Bool_typeof();
    ::TYPES[1] = ::g::Android::Base::Wrappers::JWrapper_typeof();
...
// public generated WebChromeClient() :2208
void WebChromeClient__ctor_7_fn(WebChromeClient* __this)
{
    __this->ctor_7();
}

// public generated WebChromeClient New() :2208
void WebChromeClient__New7_fn(WebChromeClient** __retval)
{
    *__retval = WebChromeClient::New7();
}

// public override sealed void onProgressChanged(Android.android.webkit.WebView arg0, int arg1) :2213
void WebChromeClient__onProgressChanged_fn(WebChromeClient* __this, ::g::Android::android::webkit::WebView* arg0, int* arg1)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(__this->ProgressChanged1, NULL))
        uPtr(__this->ProgressChanged1)->Invoke(2, __this, (::g::Uno::UX::ValueChangedArgs__New2_fn(::TYPES[78/*Uno.UX.ValueChangedArgs<double>*/], uCRef((double)uPtr(arg0)->getProgress() / 100.0), __this, &ret2), ret2));
}

// public generated void add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :2211
void WebChromeClient__add_ProgressChanged_fn(WebChromeClient* __this, uDelegate* value)
{
    __this->add_ProgressChanged(value);
}

// public generated void remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :2211
...
// public generated WebChromeClient() [instance] :2208
void WebChromeClient::ctor_7()
{
    if (!_subclassed)
    {
        _subclassed = true;
        _javaClassName = ::STRINGS[23/*"com.Binding...*/];
    }
    ...
    {
        WebChromeClient::_javaClass3() = ::g::Android::Base::JNI::LocalToGlobalRef(::g::Android::Base::JNI::LoadClass3(::STRINGS[23/*"com.Binding...*/], false));
        JniHelper jni;
        BEGIN_REG_MTD(1);
...
// public generated void add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :2211
void WebChromeClient::add_ProgressChanged(uDelegate* value)
{
    ProgressChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ProgressChanged1, value), ::TYPES[75/*Uno.UX.ValueChangedHandler<double>*/]);
}

// public generated void remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :2211
void WebChromeClient::remove_ProgressChanged(uDelegate* value)
{
    ProgressChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ProgressChanged1, value), ::TYPES[75/*Uno.UX.ValueChangedHandler<double>*/]);
}

// public generated WebChromeClient New() [static] :2208
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(2025)
// ------------------------------------------------------------------------------------------
...
WebView_type* WebView_typeof()
{
    ...
    type->interface1.fp_add_UrlChanged = (void(*)(uObject*, uDelegate*))WebView__add_UrlChanged_fn;
    type->interface1.fp_remove_UrlChanged = (void(*)(uObject*, uDelegate*))WebView__remove_UrlChanged_fn;
    type->interface2.fp_get_Progress = (void(*)(uObject*, double*))WebView__get_Progress_fn;
    type->interface2.fp_add_ProgressChanged = (void(*)(uObject*, uDelegate*))WebView__add_ProgressChanged_fn;
    type->interface2.fp_remove_ProgressChanged = (void(*)(uObject*, uDelegate*))WebView__remove_ProgressChanged_fn;
    type->interface3.fp_GoForward = (void(*)(uObject*))WebView__GoForward_fn;
    type->interface3.fp_GoBack = (void(*)(uObject*))WebView__GoBack_fn;
    type->interface3.fp_get_CanGoBack = (void(*)(uObject*, bool*))WebView__get_CanGoBack_fn;
    type->interface3.fp_get_CanGoForward = (void(*)(uObject*, bool*))WebView__get_CanGoForward_fn;
    type->interface4.fp_get_Source = (void(*)(uObject*, uString**))WebView__get_Source_fn;
    type->interface4.fp_set_Source = (void(*)(uObject*, uString*))WebView__set_Source_fn;
    type->interface0.fp_FindObjectByName = (void(*)(uObject*, uString*, uDelegate*, uObject**))::g::Fuse::Node__FindObjectByName_fn;
    ::STRINGS[24] = uString::Const("FuseJSHandler");
    ::STRINGS[25] = uString::Const("javascript:");
    ::STRINGS[8] = uString::Const("");
    ::STRINGS[26] = uString::Const("text/html");
    ::STRINGS[27] = uString::Const("UTF-8");
    ::STRINGS[28] = uString::Const("utf-8");
    ::STRINGS[29] = uString::Const("about:blank");
    ::TYPES[105] = ::g::Fuse::Controls::WebView_typeof();
    ::TYPES[106] = ::g::Fuse::Android::Controls::Control_typeof()->MakeType(::g::Fuse::Controls::WebView_typeof());
    ::TYPES[107] = ::g::Fuse::Controls::IWebView_typeof();
    ::TYPES[17] = ::g::Android::java::lang::Object_typeof();
    ::TYPES[108] = ::g::Android::java::util::Observer_typeof();
    ::TYPES[18] = ::g::Android::android::content::Context_typeof();
    ::TYPES[109] = ::g::Android::android::webkit::WebViewClient_typeof();
    ::TYPES[110] = ::g::Android::android::webkit::WebChromeClient_typeof();
    ::TYPES[111] = ::g::Fuse::Android::Controls::JsResultHandler_typeof();
    ::TYPES[19] = ::g::Android::android::view::View_typeof();
    ::TYPES[77] = ::g::Uno::Double_typeof();
    ::TYPES[112] = ::g::Fuse::Android::Controls::WebViewClient_typeof();
    ::TYPES[113] = ::g::Fuse::Android::Controls::WebChromeClient_typeof();
    type->SetInterfaces(
        ...
        ::g::Fuse::Triggers::IProgress_typeof(), offsetof(WebView_type, interface2),
        ::g::Fuse::Navigation::IBaseNavigation_typeof(), offsetof(WebView_type, interface3),
        ::g::Fuse::Controls::ISourceReceiver_typeof(), offsetof(WebView_type, interface4));
    type->SetFields(59,
...
// protected override sealed void Attach() :2058
...
void WebView__CreateInternal_fn(WebView* __this, ::g::Android::android::view::View** __retval)
{
    if (::g::Android::java::lang::Object::op_Equality1(__this->_androidWebView, NULL))
    {
        ...
        __this->_resultHandler = ::g::Fuse::Android::Controls::JsResultHandler::New5(::STRINGS[24/*"FuseJSHandler"*/], NULL);
        ...
        uPtr(uPtr(__this->_androidWebView)->getSettings())->setDomStorageEnabled(true);
...
// public generated string get_BaseUrl() [instance] :2082
uString* WebView::BaseUrl()
{
    return _BaseUrl;
}

// public generated void set_BaseUrl(string value) [instance] :2082
void WebView::BaseUrl(uString* value)
{
    _BaseUrl = value;
}

// public void add_BeginLoading(Uno.EventHandler value) [instance] :2156
void WebView::add_BeginLoading(uDelegate* value)
{
    uPtr(_webViewClient)->add_PageStarted(value);
}

// public void remove_BeginLoading(Uno.EventHandler value) [instance] :2157
void WebView::remove_BeginLoading(uDelegate* value)
{
    uPtr(_webViewClient)->remove_PageStarted(value);
}

// public bool get_CanGoBack() [instance] :2104
bool WebView::CanGoBack()
{
    return uPtr(_androidWebView)->canGoBack();
}

// public bool get_CanGoForward() [instance] :2109
bool WebView::CanGoForward()
{
    return uPtr(_androidWebView)->canGoForward();
}

// public void Eval(string js) [instance] :2075
void WebView::Eval(uString* js)
{
    uPtr(_resultHandler)->Callback = NULL;
    uPtr(_androidWebView)->loadUrl(::g::Android::java::lang::String::op_Implicit1(::g::Uno::String::op_Addition2(::STRINGS[25/*"javascript:"*/], js)));
}

// public void Eval(string js, Uno.Action<string> resultHandler) [instance] :2069
void WebView::Eval1(uString* js, uDelegate* resultHandler)
{
    uPtr(_resultHandler)->Callback = resultHandler;
    uPtr(_androidWebView)->loadUrl(::g::Android::java::lang::String::op_Implicit1(::g::Uno::String::op_Addition2(::STRINGS[25/*"javascript:"*/], uPtr(_resultHandler)->getExpr(js))));
}

// public Uno.UX.FileSource get_File() [instance] :2181
::g::Uno::UX::FileSource* WebView::File()
{
    return _file;
}

// public void set_File(Uno.UX.FileSource value) [instance] :2182
...
// public void GoBack() [instance] :2112
void WebView::GoBack()
{
    uPtr(_androidWebView)->goBack();
}

// public void GoForward() [instance] :2117
void WebView::GoForward()
{
    uPtr(_androidWebView)->goForward();
}

// private void LoadFile(Uno.UX.FileSource file) [instance] :2194
...
// public void LoadHtml(string html) [instance] :2132
...
// public void LoadHtml(string html, string baseUrl) [instance] :2137
void WebView::LoadHtml1(uString* html, uString* baseUrl)
{
    ...
    uPtr(_androidWebView)->loadDataWithBaseURL(::g::Android::java::lang::String::op_Implicit1((ind2 = (baseUrl != NULL) ? baseUrl : (uString*)BaseUrl(), (ind2 != NULL) ? ind2 : ::STRINGS[8/*""*/])), ::g::Android::java::lang::String::op_Implicit1(html), ::g::Android::java::lang::String::op_Implicit1(::STRINGS[26/*"text/html"*/]), ::g::Android::java::lang::String::op_Implicit1(::STRINGS[27/*"UTF-8"*/]), NULL);
}

// private void LoadHTML(string html) [instance] :2190
void WebView::LoadHTML(uString* html)
{
    uPtr(_androidWebView)->loadDataWithBaseURL(NULL, ::g::Android::java::lang::String::op_Implicit1(html), ::g::Android::java::lang::String::op_Implicit1(::STRINGS[26/*"text/html"*/]), ::g::Android::java::lang::String::op_Implicit1(::STRINGS[28/*"utf-8"*/]), NULL);
}

// public void LoadUrl(string url) [instance] :2143
void WebView::LoadUrl(uString* url)
{
    if (::g::Uno::String::op_Equality(url, NULL) || ::g::Uno::String::op_Equality(url, ::STRINGS[8/*""*/]))
        url = ::STRINGS[29/*"about:blank"*/];

    uPtr(_androidWebView)->loadUrl(::g::Android::java::lang::String::op_Implicit1(url));
}

// public void add_PageLoaded(Uno.EventHandler value) [instance] :2168
void WebView::add_PageLoaded(uDelegate* value)
{
    uPtr(_webViewClient)->add_PageLoaded(value);
}

// public void remove_PageLoaded(Uno.EventHandler value) [instance] :2169
void WebView::remove_PageLoaded(uDelegate* value)
{
    uPtr(_webViewClient)->remove_PageLoaded(value);
}

// public double get_Progress() [instance] :2151
double WebView::Progress()
{
    return (double)uPtr(_androidWebView)->getProgress() / 100.0;
}

// public void add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :2174
void WebView::add_ProgressChanged(uDelegate* value)
{
    uPtr(_webChromeClient)->add_ProgressChanged(value);
}

// public void remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :2175
void WebView::remove_ProgressChanged(uDelegate* value)
{
    uPtr(_webChromeClient)->remove_ProgressChanged(value);
}

// public void Reload() [instance] :2122
void WebView::Reload()
{
    uPtr(_androidWebView)->reload();
}

// public string get_Source() [instance] :2087
uString* WebView::Source()
{
    return _source;
}

// public void set_Source(string value) [instance] :2088
void WebView::Source(uString* value)
{
    LoadHtml(_source = value);
}

// public void Stop() [instance] :2127
void WebView::Stop()
{
    uPtr(_androidWebView)->stopLoading();
}

// public string get_Url() [instance] :2093
uString* WebView::Url()
{
    return ::g::Android::java::lang::String::op_Implicit(uPtr(_androidWebView)->getUrl());
}

// public void set_Url(string value) [instance] :2094
void WebView::Url(uString* value)
{
    LoadUrl(value);
}

// public void add_UrlChanged(Uno.EventHandler value) [instance] :2162
void WebView::add_UrlChanged(uDelegate* value)
{
    uPtr(_webViewClient)->add_UrlChanged(value);
}

// public void remove_UrlChanged(Uno.EventHandler value) [instance] :2163
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/Controls/$.uno(2221)
// ------------------------------------------------------------------------------------------

// internal sealed extern class WebViewClient :2221
// {
::g::Android::android::webkit::WebViewClient_type* WebViewClient_typeof()
{
    ...
    type->interface0.fp__GetJavaObject = (void(*)(uObject*, jobject*))::g::Android::Base::Wrappers::JWrapper___GetJavaObject_fn;
    type->interface0.fp__IsSubclassed = (void(*)(uObject*, bool*))::g::Android::Base::Wrappers::JWrapper___IsSubclassed_fn;
    ::STRINGS[30] = uString::Const("com.Bindings.Binding_Fuse_Android_Controls_WebViewClient");
    ::STRINGS[1] = uString::Const("<init>");
    ::STRINGS[5] = uString::Const("(J)V");
    ::TYPES[0] = ::g::Uno::Bool_typeof();
    ::TYPES[1] = ::g::Android::Base::Wrappers::JWrapper_typeof();
...
// public WebViewClient() :2231
void WebViewClient__ctor_7_fn(WebViewClient* __this)
{
    __this->ctor_7();
}

// public WebViewClient New() :2231
void WebViewClient__New7_fn(WebViewClient** __retval)
{
    *__retval = WebViewClient::New7();
}

// public override sealed void onPageFinished(Android.android.webkit.WebView view, Android.java.lang.String url) :2263
...
// public override sealed void onPageStarted(Android.android.webkit.WebView view, Android.java.lang.String url, Android.android.graphics.Bitmap favIcon) :2253
...
// public generated void add_PageLoaded(Uno.EventHandler value) :2224
void WebViewClient__add_PageLoaded_fn(WebViewClient* __this, uDelegate* value)
{
    __this->add_PageLoaded(value);
}

// public generated void remove_PageLoaded(Uno.EventHandler value) :2224
void WebViewClient__remove_PageLoaded_fn(WebViewClient* __this, uDelegate* value)
{
    __this->remove_PageLoaded(value);
}

// public generated void add_PageStarted(Uno.EventHandler value) :2225
void WebViewClient__add_PageStarted_fn(WebViewClient* __this, uDelegate* value)
{
    __this->add_PageStarted(value);
}

// public generated void remove_PageStarted(Uno.EventHandler value) :2225
void WebViewClient__remove_PageStarted_fn(WebViewClient* __this, uDelegate* value)
{
    __this->remove_PageStarted(value);
}

// public override sealed bool shouldOverrideUrlLoading(Android.android.webkit.WebView view, Android.java.lang.String url) :2237
...
// public generated void add_UrlChanged(Uno.EventHandler value) :2226
void WebViewClient__add_UrlChanged_fn(WebViewClient* __this, uDelegate* value)
{
    __this->add_UrlChanged(value);
}

// public generated void remove_UrlChanged(Uno.EventHandler value) :2226
...
// public WebViewClient() [instance] :2231
void WebViewClient::ctor_7()
{
    if (!_subclassed)
    {
        _subclassed = true;
        _javaClassName = ::STRINGS[30/*"com.Binding...*/];
    }
    ...
    {
        WebViewClient::_javaClass3() = ::g::Android::Base::JNI::LocalToGlobalRef(::g::Android::Base::JNI::LoadClass3(::STRINGS[30/*"com.Binding...*/], false));
        JniHelper jni;
        BEGIN_REG_MTD(3);
...
// public generated void add_PageLoaded(Uno.EventHandler value) [instance] :2224
void WebViewClient::add_PageLoaded(uDelegate* value)
{
    PageLoaded1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(PageLoaded1, value), ::TYPES[54/*Uno.EventHandler*/]);
}

// public generated void remove_PageLoaded(Uno.EventHandler value) [instance] :2224
void WebViewClient::remove_PageLoaded(uDelegate* value)
{
    PageLoaded1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(PageLoaded1, value), ::TYPES[54/*Uno.EventHandler*/]);
}

// public generated void add_PageStarted(Uno.EventHandler value) [instance] :2225
void WebViewClient::add_PageStarted(uDelegate* value)
{
    PageStarted1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(PageStarted1, value), ::TYPES[54/*Uno.EventHandler*/]);
}

// public generated void remove_PageStarted(Uno.EventHandler value) [instance] :2225
void WebViewClient::remove_PageStarted(uDelegate* value)
{
    PageStarted1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(PageStarted1, value), ::TYPES[54/*Uno.EventHandler*/]);
}

// public generated void add_UrlChanged(Uno.EventHandler value) [instance] :2226
void WebViewClient::add_UrlChanged(uDelegate* value)
{
    UrlChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(UrlChanged1, value), ::TYPES[54/*Uno.EventHandler*/]);
}

// public generated void remove_UrlChanged(Uno.EventHandler value) [instance] :2226
void WebViewClient::remove_UrlChanged(uDelegate* value)
{
    UrlChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(UrlChanged1, value), ::TYPES[54/*Uno.EventHandler*/]);
}

// public WebViewClient New() [static] :2231
