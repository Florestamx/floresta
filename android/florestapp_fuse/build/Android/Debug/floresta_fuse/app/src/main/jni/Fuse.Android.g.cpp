...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(253)
// --------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(1158)
// ---------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(177)
// --------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(195)
// --------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(197)
// --------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(287)
// --------------------------------------------------------------------------------
...
NativeTemplate_type* NativeTemplate_typeof()
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno");
    ::STRINGS[5] = uString::Const("Apply");
    ::TYPES[21] = ::g::Fuse::Node_typeof();
    ::TYPES[31] = ::g::Fuse::Controls::ParentControl_typeof();
...
bool NativeTemplate::Apply(uObject* obj)
{
    ...
    ::g::Fuse::Controls::ParentControl* parentControl = uAs< ::g::Fuse::Controls::ParentControl*>(obj, ::TYPES[31/*Fuse.Controls.ParentControl*/]);
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(691)
// --------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(645)
// --------------------------------------------------------------------------------
...
::g::Uno::UX::Template_type* NativeStyle__Template__Template2_typeof()
{
    ...
    ::TYPES[59] = ::g::Uno::UX::Factory_typeof();
    type->SetInterfaces(
        ::g::Uno::UX::ITemplate_typeof(), offsetof(::g::Uno::UX::Template_type, interface0));
    type->SetFields(2,
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(926)
// --------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(1002)
// ---------------------------------------------------------------------------------
...
TextRenderer_type* TextRenderer_typeof()
{
    ...
    type->interface1.fp_SoftDispose = (void(*)(uObject*))TextRenderer__FuseResourcesISoftDisposableSoftDispose_fn;
    ...
    ::TYPES[73] = ::g::Fuse::LayoutParams_typeof();
    ::TYPES[24] = ::g::Fuse::IViewport_typeof();
    ::TYPES[21] = ::g::Fuse::Node_typeof();
    ::TYPES[0] = ::g::Uno::Float_typeof();
    ::TYPES[74] = ::g::Fuse::Android::TextControlLayout_typeof();
    ::TYPES[75] = ::g::Uno::Recti_typeof();
    ::TYPES[76] = ::g::Fuse::Android::Blitter_typeof();
    ::TYPES[53] = ::g::Uno::Float2_typeof();
    ::TYPES[77] = ::g::Fuse::Controls::Graphics::Visual_typeof();
    ::TYPES[8] = ::g::Uno::Bool_typeof();
    ::TYPES[66] = ::g::Uno::Int2_typeof();
    ::TYPES[3] = ::g::Uno::Action_typeof();
    ::TYPES[63] = ::g::Uno::String_typeof();
    ::TYPES[78] = ::g::Android::android::graphics::BitmapDLRConfig_typeof();
    ::TYPES[14] = ::g::Uno::Int_typeof();
    type->SetInterfaces(
        ::g::Fuse::Scripting::INameScope_typeof(), offsetof(TextRenderer_type, interface0),
        ::g::Fuse::Resources::ISoftDisposable_typeof(), offsetof(TextRenderer_type, interface1));
    type->SetFields(58,
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(290)
// --------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(1262)
// ---------------------------------------------------------------------------------
...
{
    TypefaceCache::_typefaces_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[79/*Uno.Collections.Dictionary<string, Android.android.graphics.Typeface>*/]));
}
...
uClassType* TypefaceCache_typeof()
{
    ...
    ::TYPES[79] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Android::android::graphics::Typeface_typeof());
    ::TYPES[80] = ::g::Uno::UX::BundleFileSource_typeof();
    ::TYPES[81] = ::g::Fuse::Font_typeof();
    ::TYPES[82] = ::g::Uno::BundleFile_typeof();
    ::TYPES[83] = ::g::Uno::UX::FileSource_typeof();
    type->SetFields(0,
...
::g::Android::android::graphics::Typeface* TypefaceCache::GetTypeface(::g::Fuse::Font* font)
{
    ...
    if (uIs(uPtr(font)->File(), ::TYPES[80/*Uno.UX.BundleFileSource*/]))
        return TypefaceCache::GetTypefaceFromBundleFile(uPtr(uCast< ::g::Uno::UX::BundleFileSource*>(uPtr(font)->File(), ::TYPES[80/*Uno.UX.BundleFileSource*/]))->BundleFile);
