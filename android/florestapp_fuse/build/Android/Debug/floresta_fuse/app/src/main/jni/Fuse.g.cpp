...
static uType* TYPES[181];

namespace g{
namespace Fuse{

// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(9)
// ------------------------------------------------------------------------------
...
// protected void OnUpdate() [instance] :238
...
::g::Uno::Int4 DrawContext::GLScissor()
{
    ...
    if (::g::Uno::Int4::op_Inequality(s, _glScissor))
        GLInconsistent(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[26/*"GLScissor: "*/], uBox(::TYPES[48/*int4*/], s)), ::STRINGS[27/*" != "*/]), uBox(::TYPES[48/*int4*/], _glScissor)));
...
::g::Uno::Int2 DrawContext::GLViewportPixelSize()
{
    ...
    if (::g::Uno::Int4::op_Inequality(_glViewport, vpp))
        GLInconsistent(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[29/*"GLViewport: "*/], uBox(::TYPES[48/*int4*/], vpp)), ::STRINGS[27/*" != "*/]), uBox(::TYPES[48/*int4*/], _glViewport)));
...
{
    uArray* Vertices_9c5663de_1_1_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[52/*float2[]*/], 5, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 0.0f));
...
::g::Uno::Graphics::Framebuffer* FramebufferPoolImpl::FindBuffer(int width, int height, int format, int flags)
{
    ...
    if ((width > maxSize) || (height > maxSize))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[31/*"Attempted t...*/], uBox<int>(::TYPES[27/*int*/], width)), ::STRINGS[32/*"x"*/]), uBox<int>(::TYPES[27/*int*/], height)), ::STRINGS[33/*" framebuffe...*/]), uBox<int>(::TYPES[27/*int*/], maxSize)), ::STRINGS[32/*"x"*/]), uBox<int>(::TYPES[27/*int*/], maxSize))));
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(73)
// -------------------------------------------------------------------------------
...
App__FrameCallback_type* App__FrameCallback_typeof()
{
    ...
    ::STRINGS[36] = uString::Const("com.Bindings.Binding_Fuse_App_FrameCallback");
    ::STRINGS[37] = uString::Const("<init>");
    ::STRINGS[38] = uString::Const("(J)V");
    ::TYPES[17] = ::g::Uno::Bool_typeof();
...
void App__FrameCallback::ctor_5(::g::Fuse::App* app)
{
    ...
    {
        _subclassed = true;
        _javaClassName = ::STRINGS[36/*"com.Binding...*/];
    }
    ...
    {
        App__FrameCallback::_javaClass2() = ::g::Android::Base::JNI::LocalToGlobalRef(::g::Android::Base::JNI::LoadClass3(::STRINGS[36/*"com.Binding...*/], false));
        JniHelper jni;
        BEGIN_REG_MTD(1);
    ...
    jmethodID mtd = ::g::Android::Base::JNI::GetMethodID(tmpCls, ::STRINGS[37/*"<init>"*/], ::STRINGS[38/*"(J)V"*/]);
...
{
    ProjectionTransform = ::g::Fuse::IFrustum::GetProjectionTransform(uInterface(uPtr(frustum), ::TYPES[149/*Fuse.IFrustum*/]), viewport);
    ProjectionTransformInverse = ::g::Fuse::IFrustum::GetProjectionTransformInverse(uInterface(frustum, ::TYPES[149/*Fuse.IFrustum*/]), viewport);
    ViewTransform = ::g::Fuse::IFrustum::GetViewTransform(uInterface(frustum, ::TYPES[149/*Fuse.IFrustum*/]), viewport);
    ViewTransformInverse = ::g::Fuse::IFrustum::GetViewTransformInverse(uInterface(frustum, ::TYPES[149/*Fuse.IFrustum*/]), viewport);
...
uClassType* GraphicsWorker_typeof()
{
    ...
    ::TYPES[17] = ::g::Uno::Bool_typeof();
    ::TYPES[66] = ::g::Uno::Action_typeof();
    ::TYPES[77] = ::g::Uno::Platform::Window_typeof();
    ::TYPES[2] = ::g::Uno::Application_typeof();
    ::TYPES[14] = ::g::Uno::EventHandler_typeof();
...
void GraphicsWorker::Start()
{
    ...
    GraphicsWorker::_work() = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[78/*Uno.Threading.ConcurrentQueue<Uno.Action>*/]));
...
uClassType* Launcher_typeof()
{
    ...
    ::STRINGS[39] = uString::Const("com.google.android.apps.maps");
    ::STRINGS[40] = uString::Const("com.google.android.maps.MapsActivity");
    ::STRINGS[41] = uString::Const("tel:");
    ::STRINGS[42] = uString::Const("mailto:");
    ::STRINGS[43] = uString::Const("?");
    ::STRINGS[44] = uString::Const("cc=");
    ::STRINGS[45] = uString::Const("&");
    ::STRINGS[46] = uString::Const("bcc=");
    ::STRINGS[47] = uString::Const("subject=");
    ::STRINGS[10] = uString::Const(" ");
    ::STRINGS[48] = uString::Const("%20");
    ::STRINGS[49] = uString::Const("body=");
    ::STRINGS[50] = uString::Const(",");
    ::STRINGS[51] = uString::Const("geo:");
    ::STRINGS[52] = uString::Const("?q=");
    ::STRINGS[53] = uString::Const("geo:0,0?q=");
...
void Launcher::_launchMaps(uString* uri)
{
    ...
    mapIntent->setClassName1(::g::Android::java::lang::String::op_Implicit1(::STRINGS[39/*"com.google....*/]), ::g::Android::java::lang::String::op_Implicit1(::STRINGS[40/*"com.google....*/]));
...
void Launcher::LaunchCall(uString* callString)
{
    ...
    builder->Append1(::STRINGS[41/*"tel:"*/]);
...
{
    ::g::Uno::Text::StringBuilder* builder = ::g::Uno::Text::StringBuilder::New1();
    builder->Append1(::STRINGS[42/*"mailto:"*/]);
    builder->Append1(to);
    builder->Append1(::STRINGS[43/*"?"*/]);

    if (!::g::Uno::String::IsNullOrEmpty(carbonCopy))
    {
        uPtr(builder)->Append1(::STRINGS[44/*"cc="*/]);
        builder->Append1(carbonCopy);
    }

    if (!::g::Uno::String::IsNullOrEmpty(blindCarbonCopy))
    {
        uPtr(builder)->Append1(::STRINGS[45/*"&"*/]);
        builder->Append1(::STRINGS[46/*"bcc="*/]);
    ...
    {
        uPtr(builder)->Append1(::STRINGS[45/*"&"*/]);
        builder->Append1(::STRINGS[47/*"subject="*/]);
        builder->Append1(::g::Uno::String::Replace1(uPtr(subject), ::STRINGS[10/*" "*/], ::STRINGS[48/*"%20"*/]));
    }

    if (!::g::Uno::String::IsNullOrEmpty(message))
    {
        uPtr(builder)->Append1(::STRINGS[45/*"&"*/]);
        builder->Append1(::STRINGS[49/*"body="*/]);
        builder->Append1(::g::Uno::String::Replace1(uPtr(message), ::STRINGS[10/*" "*/], ::STRINGS[48/*"%20"*/]));
    }
...
{
    uString* latlon = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Double::ToString(latitude, ::TYPES[73/*double*/]), ::STRINGS[50/*","*/]), ::g::Uno::Double::ToString(longitude, ::TYPES[73/*double*/]));
    Launcher::_launchMaps(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[51/*"geo:"*/], latlon), ::STRINGS[52/*"?q="*/]), latlon));
}

// public static void LaunchMaps(string query) [static] :60
void Launcher::LaunchMaps2(uString* query)
{
    Launcher::_launchMaps(::g::Uno::String::op_Addition2(::STRINGS[53/*"geo:0,0?q="*/], query));
}
...
uStructType* LayoutParams_typeof()
{
    ...
    ::TYPES[34] = ::g::Uno::Float4_typeof();
    ::TYPES[17] = ::g::Uno::Bool_typeof();
    ::TYPES[86] = LayoutParams__Flags_typeof();
    ::TYPES[27] = ::g::Uno::Int_typeof();
    type->SetFields(0,
...
TranslationModes__LocalMode_type* TranslationModes__LocalMode_typeof()
{
    ...
    ::TYPES[87] = ::g::Fuse::Translation_typeof();
    type->SetInterfaces(
...
uType* MobileBootstrapping_typeof()
{
    ...
    ::TYPES[13] = ::g::Uno::Platform2::ApplicationStateTransitionHandler_typeof();
    ::TYPES[14] = ::g::Uno::EventHandler_typeof();
    ::TYPES[88] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::KeyEventArgs_typeof());
    ::TYPES[89] = ::g::Uno::Platform2::Display_typeof();
    ::TYPES[2] = ::g::Uno::Application_typeof();
    ::TYPES[90] = ::g::Uno::EventArgs_typeof();
    type->SetFields(0,
...
void MobileBootstrapping::Init()
{
    ...
    ::g::Uno::Platform2::Application::add_KeyDown(uDelegate::New(::TYPES[88/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyPressed_fn));
    ::g::Uno::Platform2::Application::add_KeyDown(uDelegate::New(::TYPES[88/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)MobileBootstrapping__OnKeyPressed_fn));
    ::g::Uno::Platform2::Application::add_KeyUp(uDelegate::New(::TYPES[88/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyReleased_fn));
    ::g::Uno::Platform2::Application::add_KeyUp(uDelegate::New(::TYPES[88/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)MobileBootstrapping__OnKeyReleased_fn));
}
...
static void Node__cctor__fn(uType* __type)
{
    ...
    Node::IsEnabledProperty_ = (::g::Fuse::StyleProperty1__New2_fn(::TYPES[91/*Fuse.StyleProperty<Fuse.Node, bool>*/], uCRef(true), uDelegate::New(::TYPES[20/*Uno.Action<Fuse.Node>*/], (void*)Node__OnIsEnabledChangedInternal_fn), NULL, NULL, &ret9), ret9);
    ...
    Node::SnapToPixelsProperty_ = (::g::Fuse::StyleProperty1__New2_fn(::TYPES[91/*Fuse.StyleProperty<Fuse.Node, bool>*/], uCRef(true), uDelegate::New(::TYPES[20/*Uno.Action<Fuse.Node>*/], (void*)Node__InvalidateLayout1_fn), uDelegate::New(::TYPES[92/*Uno.Action<Fuse.Node, bool>*/], (void*)Node__SetSnapToPixels_fn), uDelegate::New(::TYPES[93/*Uno.Func<Fuse.Node, bool>*/], (void*)Node__GetSnapToPixels_fn), &ret10), ret10);
    Node::_nameHandle_ = ::g::Fuse::Properties::CreateHandle();
    Node::NameProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[94/*Fuse.StyleProperty<Fuse.Node, string>*/], NULL, uDelegate::New(::TYPES[20/*Uno.Action<Fuse.Node>*/], (void*)Node__OnNameChanged_fn), &ret11), ret11);
...
Node_type* Node_typeof()
{
    ...
    ::STRINGS[54] = uString::Const("Should not have styling applied if not rooted");
    ::STRINGS[55] = uString::Const("Too many style properties - not enough backing store bits in Node");
    ::STRINGS[56] = uString::Const("Layout was invalidated while performing layout");
    ::STRINGS[57] = uString::Const("Rooting happening after the mixers update phase");
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.24.6/$.uno");
    ::STRINGS[58] = uString::Const("MarkRooted");
    ::STRINGS[59] = uString::Const("Unrooting happening after the mixers update phase");
    ::STRINGS[60] = uString::Const("MarkUnrooted");
    ::STRINGS[61] = uString::Const(" already has a parent");
    ::STRINGS[62] = uString::Const(" (");
    ::STRINGS[63] = uString::Const(")");
    ::STRINGS[13] = uString::Const("");
    ::STRINGS[64] = uString::Const("Invalid call to RearrangeMarginBox");
    ...
    ::TYPES[92] = ::g::Uno::Action2_typeof()->MakeType(Node_typeof(), ::g::Uno::Bool_typeof());
    ::TYPES[93] = ::g::Uno::Func1_typeof()->MakeType(Node_typeof(), ::g::Uno::Bool_typeof());
    ::TYPES[94] = ::g::Fuse::StyleProperty1_typeof()->MakeType(Node_typeof(), ::g::Uno::String_typeof());
    ...
    ::TYPES[124] = ::g::Uno::UX::Resource_typeof();
    ::TYPES[125] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ::TYPES[36] = ::g::Fuse::IViewport_typeof();
    ::TYPES[126] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof());
    ::TYPES[127] = ::g::Uno::UInt_typeof();
    ::TYPES[128] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[129] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[130] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Behavior_typeof());
    ::TYPES[131] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Behavior_typeof());
    ::TYPES[132] = ::g::Fuse::NodeBounds_typeof();
    ::TYPES[133] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ::TYPES[134] = ::g::Fuse::Layer_typeof();
    ::TYPES[135] = ::g::Fuse::LayoutRole_typeof();
    ::TYPES[136] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[137] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[138] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Style_typeof());
    ::TYPES[139] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Style_typeof());
    ::TYPES[140] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Transform_typeof());
    type->SetInterfaces(
...
{
    if (!IsRootStage(2))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[54/*"Should not ...*/]));
...
{
    if (_behaviors == NULL)
        _behaviors = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[121/*Uno.Collections.ObservableList<Fuse.Behavior>*/], uDelegate::New(::TYPES[130/*Uno.Action<Fuse.Behavior>*/], this, offsetof(Node_type, fp_OnBehaviorAdded)), uDelegate::New(::TYPES[130/*Uno.Action<Fuse.Behavior>*/], this, offsetof(Node_type, fp_OnBehaviorRemoved))));
...
uObject* Node::FindObjectByName(uString* name, uDelegate* acceptor)
{
    ...
    for (uObject* enum5 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Behaviors()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[95/*Fuse.Behavior*/]))); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum5), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
...
Node* Node::GetHitWindowPoint(::g::Uno::Float2 windowPoint)
{
    ...
    htc->PushWorldRay(::g::Fuse::IViewport::PointToWorldRay(uInterface(uPtr(Viewport()), ::TYPES[36/*Fuse.IViewport*/]), windowPoint));
    HitTest(htc);
    return htr->Node;
}
...
int Node::GetPropertyState(int id)
{
    ...
    if (id < 16)
        ...
        U_THROW(::g::Uno::Exception::New2(::STRINGS[55/*"Too many st...*/]));
}
...
void Node::InvalidateLayout(int reason)
{
    if (Node::_performingLayout())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[56/*"Layout was ...*/]));
...
{
    uPtr(uCast<uDelegate*>(obj, ::TYPES[14/*Uno.EventHandler*/]))->Invoke(2, this, uCast< ::g::Uno::EventArgs*>(args, ::TYPES[90/*Uno.EventArgs*/]));
}
...
{
    IsInteractingChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(IsInteractingChanged1, value), ::TYPES[14/*Uno.EventHandler*/]);
}
...
{
    IsInteractingChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(IsInteractingChanged1, value), ::TYPES[14/*Uno.EventHandler*/]);
}
...
bool Node::IsLocalFlat()
{
    ...
    for (uObject* enum4 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Transforms()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[123/*Fuse.Transform*/]))); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum4), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ::g::Fuse::Transform* t = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum4), ::TYPES[133/*Uno.Collections.IEnumerator<Fuse.Transform>*/]), &ret38), ret38);
        v = v && uPtr(t)->IsFlat();
    }
...
int Node::Layer()
{
    ...
    if (uPtr(Properties())->TryGet(Node::_layerProperty(), &v))
        return uUnbox<int>(::TYPES[134/*Fuse.Layer*/], v);
...
{
    uPtr(Properties())->Set(Node::_layerProperty(), uBox<int>(::TYPES[134/*Fuse.Layer*/], value));
    InvalidateLayout(2);
}
...
int Node::LayoutRole()
{
    ...
    if (uPtr(Properties())->TryGet(Node::_layoutRoleProperty(), &v))
        return uUnbox<int>(::TYPES[135/*Fuse.LayoutRole*/], v);
...
{
    uPtr(Properties())->Set(Node::_layoutRoleProperty(), uBox<int>(::TYPES[135/*Fuse.LayoutRole*/], value));
    InvalidateLayout(2);
}
...
void Node::MarkRooted()
{
    ...
    if (::g::Fuse::UpdateManager::IsPastStage(1))
        ::g::Fuse::Diagnostics::Error(::STRINGS[57/*"Rooting hap...*/], this, ::STRINGS[4/*"/usr/local/...*/], 4681, ::STRINGS[58/*"MarkRooted"*/]);
...
void Node::MarkUnrooted()
{
    ...
    if (::g::Fuse::UpdateManager::IsPastStage(1))
        ::g::Fuse::Diagnostics::Error(::STRINGS[59/*"Unrooting h...*/], this, ::STRINGS[4/*"/usr/local/...*/], 4739, ::STRINGS[60/*"MarkUnrooted"*/]);
...
void Node::OnAdded(Node* parent)
{
    ...
    {
        if (_pendingRemove == NULL)
            U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Object::ToString(this), ::STRINGS[61/*" already ha...*/]), (parent != _parent) ? (uString*)::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[62/*" ("*/], ::g::Uno::Object::ToString(uPtr(parent))), ::STRINGS[63/*")"*/]) : ::STRINGS[13/*""*/])));
...
{
    uPtr(t)->Added(this);
    t->add_MatrixChanged(uDelegate::New(::TYPES[125/*Uno.Action<Fuse.Transform>*/], (void*)Node__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
{
    uPtr(t)->Removed(this);
    t->remove_MatrixChanged(uDelegate::New(::TYPES[125/*Uno.Action<Fuse.Transform>*/], (void*)Node__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
...
{
    if (HasBit(ne))
        uPtr(Properties())->ForeachInList1(ph, uDelegate::New(::TYPES[126/*Uno.Action<object, object>*/], (void*)Node__InvokeEventHandler_fn, this), ::g::Uno::EventArgs::Empty());
}
...
{
    if (!HasMarginBox())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[64/*"Invalid cal...*/]));
...
uObject* Node::Resources()
{
    ...
    {
        SetBit(1);
        uPtr(Properties())->Set(Node::_resourcesHandle(), (::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[136/*Uno.Collections.ObservableList<Uno.UX.Resource>*/], uDelegate::New(::TYPES[137/*Uno.Action<Uno.UX.Resource>*/], (void*)Node__OnResourceChanged_fn, this), uDelegate::New(::TYPES[137/*Uno.Action<Uno.UX.Resource>*/], (void*)Node__OnResourceChanged_fn, this)));
    }
...
void Node::SetResource(uString* key, uObject* value)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[128/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); ++i)
    {
        ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[129/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret30), ret30);

        if (::g::Uno::String::op_Equality(uPtr(r)->Key(), key))
        {
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(resources), ::TYPES[129/*Uno.Collections.IList<Uno.UX.Resource>*/]), i);
            break;
        }
    }

    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(resources), ::TYPES[128/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), ::g::Uno::UX::Resource::New1(key, value));
}
...
uObject* Node::Styles()
{
    ...
    if (!uPtr(Properties())->TryGet(Node::_styleHandle(), &listobj))
    {
        listobj = (::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[138/*Uno.Collections.ObservableList<Fuse.Style>*/], uDelegate::New(::TYPES[139/*Uno.Action<Fuse.Style>*/], (void*)Node__StyleAdded_fn, this), uDelegate::New(::TYPES[139/*Uno.Action<Fuse.Style>*/], (void*)Node__StyleRemoved_fn, this));
...
{
    if (_transforms == NULL)
        _transforms = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[122/*Uno.Collections.ObservableList<Fuse.Transform>*/], uDelegate::New(::TYPES[125/*Uno.Action<Fuse.Transform>*/], (void*)Node__OnTransformAdded_fn, this), uDelegate::New(::TYPES[125/*Uno.Action<Fuse.Transform>*/], (void*)Node__OnTransformRemoved_fn, this)));
...
bool Node::TryGetResource(uString* key, uDelegate* acceptor, uObject** resource)
{
    ...
    if (HasResources())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[128/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
        {
            ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[129/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret31), ret31);
...
uType* NodeBounds_typeof()
{
    ...
    ::TYPES[115] = ::g::Uno::Float3_typeof();
    ::TYPES[141] = ::g::Uno::Geometry::Box_typeof();
    ::TYPES[74] = ::g::Uno::Float2_typeof();
    ::TYPES[100] = ::g::Fuse::FastMatrix_typeof();
    ::TYPES[17] = ::g::Uno::Bool_typeof();
    ::TYPES[3] = ::g::Fuse::Node_typeof();
...
NodeEvent_type* NodeEvent_typeof()
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.24.6/$.uno");
    ::TYPES[142] = ::g::Uno::Collections::List_typeof();
    ::TYPES[3] = ::g::Fuse::Node_typeof();
    ::TYPES[19] = uObject_typeof();
    ::TYPES[143] = ::g::Fuse::NodeEventArgs_typeof();
    ::TYPES[144] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof()->Array());
    ::TYPES[17] = ::g::Uno::Bool_typeof();
    ::TYPES[11] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[145] = uObject_typeof()->Array();
    ::TYPES[21] = ::g::Uno::Delegate_typeof();
    ::TYPES[146] = ::g::Uno::Action2_typeof();
    ::TYPES[147] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    type->SetPrecalc(
        ::TYPES[142/*Uno.Collections.List`1*/]->MakeType(type->T(0)),
        ::TYPES[146/*Uno.Action`2*/]->MakeType(type->T(1), ::TYPES[147/*Uno.Collections.IList<Fuse.Node>*/]));
    type->SetFields(0,
...
void NodeEvent::Raise(::g::Fuse::NodeEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = uDelegate::New(::TYPES[144/*Uno.Action<object, object[]>*/], (void*)NodeEvent__OnRaise_fn, this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = uDelegate::New(::TYPES[144/*Uno.Action<object, object[]>*/], (void*)NodeEvent__OnRaiseEnabled_fn, this);
            break;
        }
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[65/*"Invalid Rai...*/], 1, ::STRINGS[4/*"/usr/local/...*/], 979);
            return;
        }
    }
    ...
    for (int i = 0; i < uPtr(list)->Count(); ++i)
        uPtr(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(list), uCRef<int>(i), &ret2), ret2))->Properties())->ForeachInList(_handle, handler, uArray::Init<uObject*>(::TYPES[145/*object[]*/], 2, (::g::Uno::Collections::List__get_Item_fn(uPtr(list), uCRef<int>(i), &ret3), ret3), args));
...
{
    NodeListCache::_nodeListCache_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[148/*Uno.Collections.List<Uno.Collections.List<Fuse.Node>>*/]));
}
...
uClassType* NodeListCache_typeof()
{
    ...
    ::TYPES[148] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof()));
    ::TYPES[11] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof());
    type->SetFields(0,
...
RootViewport_type* RootViewport_typeof()
{
    ...
    type->interface1.fp_get_PointDensity = (void(*)(uObject*, float*))RootViewport__get_PointDensity_fn;
    ...
    ::STRINGS[66] = uString::Const("non-square point density: ");
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.24.6/$.uno");
    ::STRINGS[67] = uString::Const("EstablishSize");
    ::STRINGS[68] = uString::Const("A Window cannot have zero density.");
    ::TYPES[149] = ::g::Fuse::IFrustum_typeof();
    ::TYPES[77] = ::g::Uno::Platform::Window_typeof();
    ::TYPES[14] = ::g::Uno::EventHandler_typeof();
    ::TYPES[89] = ::g::Uno::Platform2::Display_typeof();
    ::TYPES[36] = ::g::Fuse::IViewport_typeof();
    ::TYPES[0] = ::g::Fuse::AppBase_typeof();
    ::TYPES[33] = ::g::Uno::Graphics::RenderTarget_typeof();
    ::TYPES[150] = ::g::Uno::Graphics::GraphicsContext_typeof();
    ::TYPES[2] = ::g::Uno::Application_typeof();
    ::TYPES[74] = ::g::Uno::Float2_typeof();
    ::TYPES[19] = uObject_typeof();
    ::TYPES[3] = ::g::Fuse::Node_typeof();
...
void RootViewport::ctor_1(::g::Uno::Platform::Window* window, float pointDensity)
{
    ...
    uPtr(::g::Uno::Platform2::Display::MainDisplay())->add_FrameChanged(uDelegate::New(::TYPES[14/*Uno.EventHandler*/], (void*)RootViewport__OnResized_fn, this));
    uPtr(_frustumViewport)->Update((uObject*)this, Frustum);
    MarkRooted();
}
...
void RootViewport::EstablishSize()
{
    ...
    if (::g::Uno::Math::Abs1(osPointDensity.X - osPointDensity.Y) > 1e-05f)
        ::g::Fuse::Diagnostics::Error(::g::Uno::String::op_Addition1(::STRINGS[66/*"non-square ...*/], uBox(::TYPES[74/*float2*/], osPointDensity)), NULL, ::STRINGS[4/*"/usr/local/...*/], 5777, ::STRINGS[67/*"EstablishSize"*/]);
    ...
    if (_defaultDensity == 0.0f)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[68/*"A Window ca...*/]));
...
::g::Fuse::Transform_type* Scaling_typeof()
{
    ...
    ::TYPES[151] = ::g::Fuse::ScalingModes_typeof();
    ::TYPES[17] = ::g::Uno::Bool_typeof();
    ::TYPES[115] = ::g::Uno::Float3_typeof();
    type->SetFields(4,
...
{
    return ::g::Fuse::IScalingMode::GetScaleVector(uInterface(uPtr(_relativeTo), ::TYPES[152/*Fuse.IScalingMode*/]), this);
}
...
uClassType* ScalingModes_typeof()
{
    ...
    ::TYPES[152] = ::g::Fuse::IScalingMode_typeof();
    type->SetFields(0,
...
uType* Stage_typeof()
{
    ...
    ::TYPES[153] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof());
    ::TYPES[154] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[155] = ::g::Fuse::UpdateListener_typeof();
    type->SetFields(0,
...
{
    Listeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[153/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    Onces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[153/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    OncesPending = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[153/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    PhaseDeferredActions = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[154/*Uno.Collections.List<Uno.Action>*/]));
...
Style_type* Style_typeof()
{
    ...
    ::TYPES[156] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::ITemplate_typeof());
    ::TYPES[17] = ::g::Uno::Bool_typeof();
    ::TYPES[157] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::ITemplate_typeof());
    ::TYPES[124] = ::g::Uno::UX::Resource_typeof();
    ::TYPES[21] = ::g::Uno::Delegate_typeof();
    ::TYPES[66] = ::g::Uno::Action_typeof();
    ::TYPES[128] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[129] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[108] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof());
    ::TYPES[158] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(Style_typeof());
    ::TYPES[136] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[137] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[97] = ::g::Uno::Collections::IList_typeof()->MakeType(Style_typeof());
    ::TYPES[159] = ::g::Uno::Collections::List_typeof()->MakeType(Style_typeof());
    ::TYPES[160] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::ITemplate_typeof());
    ::TYPES[161] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::ITemplate_typeof());
    type->SetInterfaces(
...
bool Style::Apply(uObject* target)
{
    ...
    if (_templates != NULL)
        ...
        for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_templates), ::TYPES[156/*Uno.Collections.ICollection<Uno.UX.ITemplate>*/])); (i--) > 0; )
            if (!::g::Uno::UX::ITemplate::Apply(uInterface(uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_templates), ::TYPES[157/*Uno.Collections.IList<Uno.UX.ITemplate>*/]), uCRef<int>(i), &ret5), ret5)), ::g::Uno::UX::ITemplate_typeof()), target))
                return false;
...
{
    return (_resources != NULL) && (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_resources), ::TYPES[128/*Uno.Collections.ICollection<Uno.UX.Resource>*/])) > 0);
}
...
{
    if (_resources == NULL)
        _resources = (uObject*)((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[136/*Uno.Collections.ObservableList<Uno.UX.Resource>*/], uDelegate::New(::TYPES[137/*Uno.Action<Uno.UX.Resource>*/], (void*)Style__OnResourceChanged_fn, this), uDelegate::New(::TYPES[137/*Uno.Action<Uno.UX.Resource>*/], (void*)Style__OnResourceChanged_fn, this)));
...
uObject* Style::Styles()
{
    ...
    return (ind3 != NULL) ? ind3 : (uObject*)(_styles = (uObject*)((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[159/*Uno.Collections.List<Fuse.Style>*/])));
}
...
uObject* Style::Templates()
{
    ...
    return (ind2 != NULL) ? ind2 : (uObject*)(_templates = (uObject*)((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[160/*Uno.Collections.ObservableList<Uno.UX.ITemplate>*/], uDelegate::New(::TYPES[161/*Uno.Action<Uno.UX.ITemplate>*/], (void*)Style__OnTemplateAdded_fn, this), uDelegate::New(::TYPES[161/*Uno.Action<Uno.UX.ITemplate>*/], (void*)Style__OnTemplateRemoved_fn, this))));
}
...
bool Style::TryGetResource(uString* key, uDelegate* acceptor, uObject** resource)
{
    ...
    if (HasResources())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[128/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
        {
            ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[129/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret7), ret7);
    ...
    if (_styles != NULL)
        ...
        {
            Style* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[158/*Uno.Collections.IEnumerator<Fuse.Style>*/]), &ret9), ret9);
...
StyleProperty_type* StyleProperty_typeof()
{
    ...
    ::TYPES[162] = ::g::Uno::Collections::List_typeof()->MakeType(StyleProperty_typeof());
    type->SetFields(0,
...
void StyleProperty::ctor_()
{
    if (StyleProperty::All() == NULL)
        StyleProperty::All() = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[162/*Uno.Collections.List<Fuse.StyleProperty>*/]));
...
::g::Fuse::StyleProperty_type* StyleProperty1_typeof()
{
    ...
    ::STRINGS[69] = uString::Const("Style property - must provide getter and setter as a pair");
    ::TYPES[163] = ::g::Fuse::StyleProperty_typeof();
    ::TYPES[21] = ::g::Uno::Delegate_typeof();
    ::TYPES[3] = ::g::Fuse::Node_typeof();
    ::TYPES[19] = uObject_typeof();
    ::TYPES[164] = ::g::Uno::Func1_typeof();
    ::TYPES[27] = ::g::Uno::Int_typeof();
    ::TYPES[165] = ::g::Uno::Action1_typeof();
    ::TYPES[146] = ::g::Uno::Action2_typeof();
    ::TYPES[17] = ::g::Uno::Bool_typeof();
    type->SetPrecalc(
        ::TYPES[164/*Uno.Func`2*/]->MakeType(type->T(0), type->T(1)),
        ::TYPES[165/*Uno.Action`1*/]->MakeType(type->T(0)),
        ::TYPES[146/*Uno.Action`2*/]->MakeType(type->T(0), type->T(1)));
    type->SetFields(0,
...
void StyleProperty1__ctor_2_fn(StyleProperty1* __this, void* defaultValue, uDelegate* changedCallback, uDelegate* setter, uDelegate* getter)
{
    ...
    if (::g::Uno::Delegate::op_Equality(__this->_setter, NULL) != ::g::Uno::Delegate::op_Equality(__this->_getter, NULL))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[69/*"Style prope...*/]));
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.Android/0.24.6/$.uno(41)
// -------------------------------------------------------------------------------
...
App__TimeListener_type* App__TimeListener_typeof()
{
    ...
    type->interface0.fp__IsSubclassed = (void(*)(uObject*, bool*))::g::Android::Base::Wrappers::JWrapper___IsSubclassed_fn;
    type->interface1.fp_Dispose = (void(*)(uObject*))::g::Android::Base::Wrappers::JWrapper__UnoIDisposableDispose_fn;
    ::STRINGS[70] = uString::Const("com.Bindings.Binding_Fuse_App_TimeListener");
    ::STRINGS[37] = uString::Const("<init>");
    ::STRINGS[38] = uString::Const("(J)V");
    ::TYPES[17] = ::g::Uno::Bool_typeof();
    ::TYPES[71] = ::g::Android::Base::Wrappers::JWrapper_typeof();
...
void App__TimeListener::ctor_5(::g::Fuse::App* app)
{
    ...
    {
        _subclassed = true;
        _javaClassName = ::STRINGS[70/*"com.Binding...*/];
    }
    ...
    {
        App__TimeListener::_javaClass2() = ::g::Android::Base::JNI::LocalToGlobalRef(::g::Android::Base::JNI::LoadClass3(::STRINGS[70/*"com.Binding...*/], false));
        JniHelper jni;
        BEGIN_REG_MTD(1);
...
Transform_type* Transform_typeof()
{
    ...
    ::TYPES[21] = ::g::Uno::Delegate_typeof();
    ::TYPES[125] = ::g::Uno::Action1_typeof()->MakeType(Transform_typeof());
    type->SetFields(0,
...
{
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(MatrixChanged1, value), ::TYPES[125/*Uno.Action<Fuse.Transform>*/]);
}
...
{
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(MatrixChanged1, value), ::TYPES[125/*Uno.Action<Fuse.Transform>*/]);
}
...
::g::Fuse::Transform_type* Translation_typeof()
{
    ...
    ::TYPES[166] = ::g::Fuse::TranslationModes_typeof();
    ::TYPES[115] = ::g::Uno::Float3_typeof();
    ::TYPES[123] = ::g::Fuse::Transform_typeof();
    ::TYPES[167] = ::g::Fuse::ITransformMode_typeof();
    ::TYPES[27] = ::g::Uno::Int_typeof();
    ::TYPES[3] = ::g::Fuse::Node_typeof();
    ::TYPES[168] = ::g::Fuse::IActualPlacement_typeof();
    ::TYPES[169] = ::g::Fuse::PlacedHandler_typeof();
    ::TYPES[14] = ::g::Uno::EventHandler_typeof();
    type->SetFields(4,
...
{
    float weight_ = *weight;
    ::g::Uno::Float3 v = ::g::Uno::Float3__op_Multiply1(::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr(__this->RelativeTo()), ::TYPES[170/*Fuse.ITranslationMode*/]), __this), weight_);
...
{
    ::g::Uno::Float3 v = ::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr(__this->RelativeTo()), ::TYPES[170/*Fuse.ITranslationMode*/]), __this);
...
void Translation::CheckSubscription()
{
    ...
    int flags = ::g::Fuse::ITransformMode::Flags(uInterface(uPtr(RelativeTo()), ::TYPES[167/*Fuse.ITransformMode*/]));
    ...
    uObject* act = uAs<uObject*>(node, ::TYPES[168/*Fuse.IActualPlacement*/]);

    if (_subscribed != act)
    {
        if (_subscribed != NULL)
        {
            ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(_subscribed), ::TYPES[168/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[169/*Fuse.PlacedHandler*/], (void*)Translation__OnPlaced_fn, this));
            _subscribed = NULL;
        }

        if (act != NULL)
        {
            ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(act), ::TYPES[168/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[169/*Fuse.PlacedHandler*/], (void*)Translation__OnPlaced_fn, this));
            _subscribed = act;
        }
    }
...
uClassType* TranslationModes_typeof()
{
    ...
    ::TYPES[170] = ::g::Fuse::ITranslationMode_typeof();
    ::TYPES[168] = ::g::Fuse::IActualPlacement_typeof();
    type->SetFields(0,
...
::g::Uno::Float3 TranslationModes::RelativeToSize(::g::Uno::Float3 v, ::g::Fuse::Node* node)
{
    ...
    uObject* isz = uAs<uObject*>(node, ::TYPES[168/*Fuse.IActualPlacement*/]);

    if (isz == NULL)
        return v;

    return ::g::Uno::Float3__op_Multiply2(v, ::g::Fuse::IActualPlacement::ActualSize(uInterface(uPtr(isz), ::TYPES[168/*Fuse.IActualPlacement*/])));
}
// }
...
{
    UpdateManager::_stages_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[171/*Uno.Collections.List<Fuse.Stage>*/]));
    UpdateManager::_postActions_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[154/*Uno.Collections.List<Uno.Action>*/]));
    UpdateManager::_postActionsSwap_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[154/*Uno.Collections.List<Uno.Action>*/]));
...
uClassType* UpdateManager_typeof()
{
    ...
    ::STRINGS[72] = uString::Const("no OnceAction found to remove");
    ::TYPES[171] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Stage_typeof());
    ::TYPES[154] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[172] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[173] = ::g::Fuse::UpdateStage_typeof();
    ::TYPES[155] = ::g::Fuse::UpdateListener_typeof();
    ::TYPES[27] = ::g::Uno::Int_typeof();
    ::TYPES[174] = ::g::Fuse::Stage_typeof();
    ::TYPES[66] = ::g::Uno::Action_typeof();
    ::TYPES[175] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Exception_typeof());
    ::TYPES[17] = ::g::Uno::Bool_typeof();
    ::TYPES[153] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof());
    ::TYPES[19] = uObject_typeof();
    type->SetFields(0,
    ...
    while (true)
    {
        ...
        for (int i = 0; i < uPtr(a)->Count(); ++i)
            ...
            catch (const uThrowable& __t)
            {
                ...
                if (_exceptions == NULL)
                    _exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[175/*Uno.Collections.List<Uno.Exception>*/]);
...
void UpdateManager::RemoveOnceAction(uDelegate* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Onces, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[72/*"no OnceActi...*/]));
}
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::g::Fuse::Scripting::IEventSerializer_typeof()), ::STRINGS[73/*"name"*/], uPtr(__this->Dispatch())->Name());
...
uType* UserEventDispatch_typeof()
{
    ...
    ::TYPES[21] = ::g::Uno::Delegate_typeof();
    ::TYPES[180] = ::g::Fuse::UserEventHandler_typeof();
    ::TYPES[19] = uObject_typeof();
    ::TYPES[66] = ::g::Uno::Action_typeof();
    type->SetFields(0,
...
{
    ::g::Fuse::UserEventArgs* m = ::g::Fuse::UserEventArgs::New2(this, source, args);
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[66/*Uno.Action*/], (void*)::g::Fuse::UserEventArgs__Raise_fn, m), -1);
}
...
{
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Raised1, value), ::TYPES[180/*Fuse.UserEventHandler*/]);
}
...
{
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Raised1, value), ::TYPES[180/*Fuse.UserEventHandler*/]);
}
