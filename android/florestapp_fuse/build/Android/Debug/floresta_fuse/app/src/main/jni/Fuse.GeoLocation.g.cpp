...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.GeoLocation/0.24.6/Android/$.uno(19)
// -------------------------------------------------------------------------------------------
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.GeoLocation/0.24.6/Android/$.uno(161)
// --------------------------------------------------------------------------------------------
...
uType* LocationTracker_typeof()
{
    ...
    ::STRINGS[9] = uString::Const("Not supported for current target.");
...
::g::Uno::Threading::Future1* LocationTracker::GetLocationAsync(double timeout)
{
    ...
    if (LocationTracker::_locationTracker() != NULL)
    {
        ...
        promise->Reject(::g::Uno::Exception::New2(::STRINGS[9/*"Not support...*/]));
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.GeoLocation/0.24.6/Android/$.uno(183)
// --------------------------------------------------------------------------------------------
...
::g::Fuse::GeoLocation::TimeoutListener_type* PromiseListener_typeof()
{
    ...
    type->interface0.fp__IsSubclassed = (void(*)(uObject*, bool*))::g::Android::Base::Wrappers::JWrapper___IsSubclassed_fn;
    type->interface1.fp_Dispose = (void(*)(uObject*))::g::Android::Base::Wrappers::JWrapper__UnoIDisposableDispose_fn;
    ::STRINGS[10] = uString::Const("Location request timed out");
...
void PromiseListener__OnTimeout_fn(PromiseListener* __this)
{
    ...
    uPtr(__this->_promise)->Reject(::g::Uno::Exception::New2(::STRINGS[10/*"Location re...*/]));
}
...
// ../../../../../../../usr/local/share/uno/Packages/Fuse.GeoLocation/0.24.6/Android/$.uno(220)
// --------------------------------------------------------------------------------------------
