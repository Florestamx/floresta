...
// public void EnableCache(bool enableCache) :461
...
// private void FireSetHeadersReceived() :449
...
// public void EnableCache(bool enableCache) [instance] :461
void HttpMessageHandlerRequest::EnableCache(bool enableCache)
{
    ...
    ::g::Uno::Net::Http::Implementation::IHttpRequest::EnableCache(uInterface(uPtr(_httpRequest), ::TYPES[17/*Uno.Net.Http.Implementation.IHttpRequest*/]), enableCache);
}
...
// private void FireSetHeadersReceived() [instance] :449
...
// internal void OnHeadersReceived() [instance] :445
...
// internal void OnProgress(int current, int total, bool hasTotal) [instance] :454
...
// ../../../../../../../usr/local/share/uno/Packages/Uno.Net.Http/0.24.3/$.uno(384)
// --------------------------------------------------------------------------------

// private sealed class HttpMessageHandlerRequest.ProgressClosure :384
// {
...
// public ProgressClosure(Uno.Net.Http.HttpRequestState state, Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool> action, Uno.Net.Http.HttpMessageHandlerRequest request, int current, int total, bool hasTotal) :393
...
// public ProgressClosure New(Uno.Net.Http.HttpRequestState state, Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool> action, Uno.Net.Http.HttpMessageHandlerRequest request, int current, int total, bool hasTotal) :393
...
// public ProgressClosure(Uno.Net.Http.HttpRequestState state, Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool> action, Uno.Net.Http.HttpMessageHandlerRequest request, int current, int total, bool hasTotal) [instance] :393
...
// public ProgressClosure New(Uno.Net.Http.HttpRequestState state, Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool> action, Uno.Net.Http.HttpMessageHandlerRequest request, int current, int total, bool hasTotal) [static] :393
