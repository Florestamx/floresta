sealed class floresta_fuse_FuseControlsPageControl_FuseNode_Active_Property: Uno.UX.Property<Fuse.Node>
{
    Fuse.Controls.PageControl _obj;
    public floresta_fuse_FuseControlsPageControl_FuseNode_Active_Property(Fuse.Controls.PageControl obj) { _obj = obj;  }
...
sealed class floresta_fuse_FuseControlsTextControl_string_Value_Property: Uno.UX.Property<string>
{
    Fuse.Controls.TextControl _obj;
    public floresta_fuse_FuseControlsTextControl_string_Value_Property(Fuse.Controls.TextControl obj) { _obj = obj; obj.ValueChanged += this.OnValueChanged; }
...
sealed class floresta_fuse_FuseNode_bool_IsEnabled_Property: Uno.UX.Property<bool>
{
    Fuse.Node _obj;
    public floresta_fuse_FuseNode_bool_IsEnabled_Property(Fuse.Node obj) { _obj = obj;  }
