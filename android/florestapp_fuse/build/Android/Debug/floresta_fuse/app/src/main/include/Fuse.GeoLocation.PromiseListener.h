// This file was generated based on '/usr/local/share/uno/Packages/Fuse.GeoLocation/0.24.6/Android/$.uno'.
...
struct PromiseListener : ::g::Fuse::GeoLocation::TimeoutListener
{
    ...
    void ctor_7(::g::Android::android::location::LocationManager* lm, double timeout, ::g::Uno::Threading::Promise* promise);
