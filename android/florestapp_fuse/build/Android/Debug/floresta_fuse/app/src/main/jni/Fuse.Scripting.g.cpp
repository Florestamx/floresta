...
Context_type* Context_typeof()
{
    ...
    ::STRINGS[14] = uString::Const("(function(obj, name, getCallback, setCallback, e, c) { Object.defineProperty(obj, name, { get: getCallback, set: setCallback, enumerable: e, configurable: c }); })");
    ...
    ::STRINGS[16] = uString::Const("require(): accepts exactly one argument, ");
    ::STRINGS[17] = uString::Const(" provided");
    ::STRINGS[18] = uString::Const("require(): argument must be a string");
    ::STRINGS[19] = uString::Const("require(): module not found: ");
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate1(::STRINGS[13/*""*/], ::STRINGS[14/*"(function(o...*/]), ::TYPES[10/*Fuse.Scripting.Function*/]);
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate1(::STRINGS[13/*""*/], ::STRINGS[15/*"(function(o...*/]), ::TYPES[10/*Fuse.Scripting.Function*/]);
...
uObject* Context::Require(uArray* args)
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[16/*"require(): ...*/], uBox<int>(::TYPES[51/*int*/], uPtr(args)->Length())), ::STRINGS[17/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[8/*string*/]);

    if (::g::Uno::String::op_Equality(id, NULL))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[18/*"require(): ...*/]));
...
uObject* Context::Require1(uString* id)
{
    ...
    if (!(::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_moduleResults), id, (void**)(&modRes), &ret1), ret1))
    {
        ...
        if (!::g::Uno::UX::Resource::TryFindGlobal(id, uDelegate::New(::TYPES[15/*Uno.Predicate<object>*/], (void*)Context__Acceptor_fn, this), &res))
            U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::STRINGS[19/*"require(): ...*/], id)));
...
uObject* NativePromise__ContextClosure::CreatePromise(uArray* args)
{
    ...
    ::g::Fuse::Scripting::Function* promise = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_c)->GlobalObject())->Item(::STRINGS[20/*"Promise"*/]), ::TYPES[10/*Fuse.Scripting.Function*/]);
...
uClassType* JSCallback_typeof()
{
    ...
    ::TYPES[12] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[24] = JSCallback__ActionClosure1_typeof();
    ::TYPES[25] = JSCallback__ActionClosure2_typeof();
    ::TYPES[26] = JSCallback__FuncClosure_typeof();
    ::TYPES[27] = JSCallback__FuncClosure1_typeof();
    ::TYPES[11] = uObject_typeof()->Array();
    ::TYPES[28] = JSCallback__NumberConverter_typeof();
    return type;
}
...
void JSCallback__GetArg_fn(uType* __type, uArray* args, uTRef arg, int* index, bool* __retval)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[28/*Fuse.Scripting.JSCallback.NumberConverter*/]->MakeMethod(1, __type->U(0)),
    };
    int index_ = *index;
    bool ret1;
...
{
    uType* __types[] = {
        ::TYPES[24/*Fuse.Scripting.JSCallback.ActionClosure`1*/]->MakeType(__type->U(0)),
        __type->U(0),
    };
...
{
    uType* __types[] = {
        ::TYPES[25/*Fuse.Scripting.JSCallback.ActionClosure`2*/]->MakeType(__type->U(0), __type->U(1)),
        __type->U(0),
        __type->U(1),
    };
...
{
    uType* __types[] = {
        ::TYPES[26/*Fuse.Scripting.JSCallback.FuncClosure`1*/]->MakeType(__type->U(0)),
        __type->U(0),
    };
...
{
    uType* __types[] = {
        ::TYPES[27/*Fuse.Scripting.JSCallback.FuncClosure`2*/]->MakeType(__type->U(0), __type->U(1)),
        __type->U(0),
        __type->U(1),
    };
...
{
    NameRegistry::_names_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[29/*Uno.Collections.Dictionary<object, string>*/]));
    NameRegistry::_listeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[30/*Uno.Collections.Dictionary<string, Uno.Collections.List<Fuse.Scripting.INameListener>>*/]));
}
...
uClassType* NameRegistry_typeof()
{
    ...
    ::TYPES[29] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(uObject_typeof(), ::g::Uno::String_typeof());
    ::TYPES[30] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::INameListener_typeof()));
    ::TYPES[14] = ::g::Uno::Bool_typeof();
    ::TYPES[31] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::INameListener_typeof());
    ::TYPES[32] = ::g::Fuse::Scripting::INameListener_typeof()->Array();
    ::TYPES[33] = ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::INameListener_typeof()));
    type->SetFields(0,
...
void NameRegistry::AddListener(uString* name, uObject* listener)
{
    ...
    if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_listeners()), name, &ret5), ret5))
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(NameRegistry::_listeners()), name, (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[31/*Uno.Collections.List<Fuse.Scripting.INameListener>*/]));
...
void NameRegistry::RemoveListener(uObject* listener)
{
    ...
    for (::g::Uno::Collections::Dictionary__ValueCollection__Enumerator<uStrong< ::g::Uno::Collections::List*> > enum1 = (::g::Uno::Collections::Dictionary__ValueCollection__GetEnumerator_fn(uPtr((::g::Uno::Collections::Dictionary__ValueCollection*)uPtr(NameRegistry::_listeners())->Values()), &ret16), ret16); enum1.MoveNext(::TYPES[33/*Uno.Collections.Dictionary<string, Uno.Collections.List<Fuse.Scripting.INameListener>>.ValueCollection.Enumerator*/]); )
    {
        ::g::Uno::Collections::List* list = enum1.Current(::TYPES[33/*Uno.Collections.Dictionary<string, Uno.Collections.List<Fuse.Scripting.INameListener>>.ValueCollection.Enumerator*/]);
...
::g::Fuse::Scripting::NativeProperty_type* NativeEvent_typeof()
{
    ...
    ::TYPES[34] = ::g::Uno::Collections::Queue_typeof()->MakeType(uObject_typeof()->Array());
    ::TYPES[35] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(2, uObject_typeof()->Array(), uObject_typeof());
    ::TYPES[16] = ::g::Fuse::Scripting::Context_typeof();
    ::TYPES[36] = ::g::Fuse::Scripting::NativeMember_typeof();
    ::TYPES[37] = ::g::Uno::Func1_typeof()->MakeType(uObject_typeof()->Array(), uObject_typeof());
    type->SetFields(8,
...
{
    ctor_1(name);
    _eventArgsQueue = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[34/*Uno.Collections.Queue<object[]>*/]));
...
void NativeEvent::DispatchQueue()
{
    ...
    while ((uPtr(_eventArgsQueue)->Count() > 0) && (_jsFunction != NULL))
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[35/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher, uDelegate::New(::TYPES[37/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), (::g::Uno::Collections::Queue__Dequeue_fn(uPtr(_eventArgsQueue), &ret2), ret2));
}
...
NativeModule_type* NativeModule_typeof()
{
    ...
    ::STRINGS[21] = uString::Const("NativeModule(): Cannot add more members after first use");
    ::STRINGS[12] = uString::Const("new Object()");
    ::STRINGS[22] = uString::Const("Cannot get Code from NativeModule");
    ::STRINGS[23] = uString::Const("Cannot get FileName from NativeModule");
...
{
    U_THROW(::g::Uno::Exception::New2(::STRINGS[22/*"Cannot get ...*/]));
}
...
{
    if (_isEvaluated)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[21/*"NativeModul...*/]));
...
::g::Uno::Exception_type* ScriptException_typeof()
{
    ...
    ::STRINGS[24] = uString::Const("Name: ");
    ::STRINGS[25] = uString::Const("Error message: ");
    ::STRINGS[26] = uString::Const("File name: ");
    ::STRINGS[27] = uString::Const("Line number: ");
    ::STRINGS[28] = uString::Const("Source line: ");
    ::STRINGS[29] = uString::Const("JS stack trace: ");
    ::TYPES[14] = ::g::Uno::Bool_typeof();
    ::TYPES[51] = ::g::Uno::Int_typeof();
    type->SetFields(3,
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    {
        uPtr(stringBuilder)->Append1(::STRINGS[28/*"Source line: "*/]);
        stringBuilder->AppendLine(__this->SourceLine());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->JSStackTrace()))
    {
        uPtr(stringBuilder)->Append1(::STRINGS[29/*"JS stack tr...*/]);
