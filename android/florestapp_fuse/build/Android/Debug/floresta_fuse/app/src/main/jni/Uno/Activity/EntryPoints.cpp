...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/floresta_fuse/floresta_fuse");
    jclass entryPointsClass = env->FindClass("com/floresta_fuse/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/floresta_fuse/Display");
