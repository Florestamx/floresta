...
public class ExternedBlockHost
{
    public static void SetNavigationBarVisible_0(final Object _this, boolean visible)
    {
        ...
        {
        	android.view.View decorView = com.floresta_fuse.floresta_fuse.GetRootActivity().getWindow().getDecorView();
    ...
    {
        android.view.Window window = com.floresta_fuse.floresta_fuse.GetRootActivity().getWindow();
