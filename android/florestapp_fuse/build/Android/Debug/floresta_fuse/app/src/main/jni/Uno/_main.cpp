...
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* floresta_fuse_FuseControlsPageControl_FuseNode_Active_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* floresta_fuse_FuseControlsTextControl_string_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* floresta_fuse_FuseNode_bool_IsEnabled_Property_typeof();}
...
namespace g{uClassType* floresta_fuse_bundle_typeof();}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::floresta_fuse_bundle_typeof,
        (uType*(*)())&::g::floresta_fuse_FuseControlsPageControl_FuseNode_Active_Property_typeof,
        (uType*(*)())&::g::floresta_fuse_FuseControlsTextControl_string_Value_Property_typeof,
        (uType*(*)())&::g::floresta_fuse_FuseNode_bool_IsEnabled_Property_typeof,
